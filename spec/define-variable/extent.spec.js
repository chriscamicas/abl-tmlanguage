...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 55, "endIndex": 58, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '123'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 43, "endIndex": 44, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '3'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 35, "endIndex": 36, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
    { "startIndex": 36, "endIndex": 39, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '0x4'
    { "startIndex": 39, "endIndex": 40, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
    { "startIndex": 40, "endIndex": 47, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'no-undo'
    { "startIndex": 47, "endIndex": 48, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 62, "endIndex": 64, "scopes": ["source.abl", "meta.define.abl", "meta.array.literal.abl", "constant.numeric.abl"] },  // '-1'
    ...
    { "startIndex": 66, "endIndex": 68, "scopes": ["source.abl", "meta.define.abl", "meta.array.literal.abl", "constant.numeric.abl"] },  // '-3'
    ...
    { "startIndex": 70, "endIndex": 72, "scopes": ["source.abl", "meta.define.abl", "meta.array.literal.abl", "constant.numeric.abl"] },  // '-5'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 60, "endIndex": 61, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
    { "startIndex": 61, "endIndex": 62, "scopes": ["source.abl", "meta.define.abl", "meta.array.literal.abl", "punctuation.definition.bracket.square.begin.abl"] },  // '['
    { "startIndex": 62, "endIndex": 63, "scopes": ["source.abl", "meta.define.abl", "meta.array.literal.abl", "constant.numeric.abl"] },  // '2'
    ...
    { "startIndex": 65, "endIndex": 67, "scopes": ["source.abl", "meta.define.abl", "meta.array.literal.abl", "constant.numeric.abl"] },  // '-3'
    ...
    { "startIndex": 69, "endIndex": 72, "scopes": ["source.abl", "meta.define.abl", "meta.array.literal.abl", "constant.numeric.abl"] },  // '0x4'
    { "startIndex": 72, "endIndex": 73, "scopes": ["source.abl", "meta.define.abl", "meta.array.literal.abl", "punctuation.definition.bracket.square.end.abl"] },  // ']'
    { "startIndex": 73, "endIndex": 74, "scopes": ["source.abl", "meta.define.abl", "punctuation.terminator.abl"] }  // '.'
  ];
  shared.itShouldMatchExpectedScopes(statement, expectedTokens);
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 35, "endIndex": 36, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '3'
    { "startIndex": 36, "endIndex": 37, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 24, "endIndex": 27, "scopes": ["source.abl", "meta.define.abl", "meta.array.literal.abl", "constant.numeric.abl"] },  // '128'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 31, "endIndex": 33, "scopes": ["source.abl", "meta.define.method.abl", "constant.numeric.abl"] },  // '12'
    ...
    { "startIndex": 84, "endIndex": 85, "scopes": ["source.abl", "meta.define.method.abl", "meta.brace.round.abl"] },  // ')'
