...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 46, "endIndex": 48, "scopes": ["source.abl", "comment.block.abl"] },
    { "startIndex": 48, "endIndex": 57, "scopes": ["source.abl", "comment.block.abl", "comment"] },
    { "startIndex": 57, "endIndex": 59, "scopes": ["source.abl", "comment.block.abl"] }
  ];
