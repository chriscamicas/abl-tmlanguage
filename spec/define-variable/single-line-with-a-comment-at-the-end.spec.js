...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 36, "endIndex": 37, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl"] },  // ' '
    { "startIndex": 37, "endIndex": 44, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl", "keyword.other.abl"] },  // 'no-undo'
    { "startIndex": 44, "endIndex": 45, "scopes": ["source.abl", "punctuation.terminator.abl"] },  // '.'
    { "startIndex": 45, "endIndex": 54, "scopes": ["source.abl", "comment.source.abl"] }  // '// comment'      
  ];
  shared.itShouldMatchExpectedScopes(statement, expectedTokens);
})
