...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 21, "endIndex": 22, "scopes": ["source.abl", "meta.define.abl", "meta.array.literal.abl", "constant.numeric.abl"] },  // '4'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 44, "endIndex": 45, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
    ...
    { "startIndex": 59, "endIndex": 62, "scopes": ["source.abl", "support.function.abl"] },  // 'now'
    { "startIndex": 62, "endIndex": 63, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
    { "startIndex": 63, "endIndex": 64, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 64, "endIndex": 66, "scopes": ["source.abl", "constant.numeric.abl"] },  // '12'
    { "startIndex": 66, "endIndex": 67, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
    { "startIndex": 67, "endIndex": 68, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 68, "endIndex": 69, "scopes": ["source.abl", "string.quoted.single.abl", "punctuation.definition.string.begin.abl"] },  // '''
    { "startIndex": 69, "endIndex": 81, "scopes": ["source.abl", "string.quoted.single.abl"] },  // 'milliseconds'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 4, "endIndex": 10, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'public'
    { "startIndex": 10, "endIndex": 11, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
    { "startIndex": 11, "endIndex": 13, "scopes": ["source.abl", "meta.define.abl", "comment.block.abl"] },  // '/*'
    { "startIndex": 13, "endIndex": 27, "scopes": ["source.abl", "meta.define.abl", "comment.block.abl", "comment"] },  // 'must be public'
    { "startIndex": 27, "endIndex": 29, "scopes": ["source.abl", "meta.define.abl", "comment.block.abl"] },  // '*/'
    ...
    { "startIndex": 63, "endIndex": 64, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 64, "endIndex": 65, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 25, "endIndex": 26, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 50, "endIndex": 55, "scopes": ["source.abl", "variable.other.abl"] },  // 'pItem'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 18, "endIndex": 20, "scopes": ["source.abl", "constant.numeric.abl"] },  // '22'
    { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 21, "endIndex": 22, "scopes": ["source.abl", "keyword.operator.abl"] },  // '/'
    { "startIndex": 22, "endIndex": 23, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 23, "endIndex": 24, "scopes": ["source.abl", "constant.numeric.abl"] },  // '3'
    ...
    { "startIndex": 32, "endIndex": 33, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
    { "startIndex": 33, "endIndex": 34, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 34, "endIndex": 43, "scopes": ["source.abl", "constant.numeric.abl"] },  // '3.1415927'
