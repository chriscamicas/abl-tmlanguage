...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 49, "endIndex": 50, "scopes": ["source.abl", "meta.define.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 50, "endIndex": 51, "scopes": ["source.abl", "meta.define.abl", "meta.brace.round.abl"] },  // ')'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 98, "endIndex": 99, "scopes": ["source.abl", "meta.define.abl", "meta.brace.round.abl"] },  // ')'
