...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 41, "endIndex": 47, "scopes": ["source.abl", "comment.block.abl", "comment"] },  // ' cred '
    { "startIndex": 47, "endIndex": 49, "scopes": ["source.abl", "comment.block.abl"] },  // '*/'
    { "startIndex": 49, "endIndex": 50, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
    { "startIndex": 50, "endIndex": 51, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 51, "endIndex": 55, "scopes": ["source.abl", "variable.other.abl"] },  // 'opts'
    { "startIndex": 55, "endIndex": 56, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
    { "startIndex": 56, "endIndex": 57, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 57, "endIndex": 63, "scopes": ["source.abl", "keyword.other.abl"] },  // 'output'
    { "startIndex": 63, "endIndex": 64, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 64, "endIndex": 71, "scopes": ["source.abl", "variable.other.abl"] },  // 'xStatus'
    { "startIndex": 71, "endIndex": 72, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
    { "startIndex": 72, "endIndex": 73, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 73, "endIndex": 79, "scopes": ["source.abl", "keyword.other.abl"] },  // 'output'
    { "startIndex": 79, "endIndex": 80, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 80, "endIndex": 86, "scopes": ["source.abl", "keyword.other.abl"] },  // 'result'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 73, "endIndex": 79, "scopes": ["source.abl", "keyword.other.abl"] },  // 'output'
    { "startIndex": 79, "endIndex": 80, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 80, "endIndex": 88, "scopes": ["source.abl", "variable.other.abl"] },  // 'vlResult'
    { "startIndex": 88, "endIndex": 89, "scopes": ["source.abl"] },  // ' '
