...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 21, "endIndex": 105, "scopes": ["source.abl", "comment.block.abl", "comment"] },  // 'FIELDS (SYSTEM-ID web-key bom-key kit-seq-num req-date line-num entry-key order-num)'
      { "startIndex": 105, "endIndex": 107, "scopes": ["source.abl", "comment.block.abl"] },  // '*/'
    ...
    [
      ...
      { "startIndex": 27, "endIndex": 37, "scopes": ["source.abl", "variable.other.abl"] },  // 'ip-web-key'
