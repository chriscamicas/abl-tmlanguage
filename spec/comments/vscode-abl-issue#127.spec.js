...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "meta.define.abl", "punctuation.accessor.abl"] },  // ':'
      ...
      { "startIndex": 30, "endIndex": 32, "scopes": ["source.abl", "meta.define.abl", "keyword.operator.abl"] },  // 'eq'
    ...
    [
      ...
      { "startIndex": 33, "endIndex": 34, "scopes": ["source.abl", "meta.define.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 34, "endIndex": 44, "scopes": ["source.abl", "meta.define.abl", "variable.other.abl"] },  // 'mUTF8Value'
      { "startIndex": 44, "endIndex": 45, "scopes": ["source.abl", "meta.define.abl", "punctuation.separator.comma.abl"] },  // ','
      { "startIndex": 45, "endIndex": 46, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 46, "endIndex": 57, "scopes": ["source.abl", "meta.define.abl", "variable.language.abl"] },  // 'this-object'
      { "startIndex": 57, "endIndex": 58, "scopes": ["source.abl", "meta.define.abl", "punctuation.accessor.abl"] },  // ':'
      { "startIndex": 58, "endIndex": 66, "scopes": ["source.abl", "meta.define.abl", "entity.name.function.abl"] },  // 'Encoding'
      { "startIndex": 66, "endIndex": 67, "scopes": ["source.abl", "meta.define.abl", "meta.brace.round.abl"] },  // ')'
