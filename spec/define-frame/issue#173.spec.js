...
with down# down row 12 no-labels no-box frame f-body.`;
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 5, "endIndex": 7, "scopes": ["source.abl", "constant.numeric.abl"] }  // '15'
    ],
    [
      { "startIndex": 0, "endIndex": 4, "scopes": ["source.abl", "support.function.abl"] },  // 'skip'
      { "startIndex": 4, "endIndex": 5, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    ...
    [
      ...
      { "startIndex": 20, "endIndex": 22, "scopes": ["source.abl", "constant.numeric.abl"] },  // '12'
...
DEFINE new shared priVATE FRAME FRAME-A
     ...
     custname.group-id AT ROW 13.29 COL 13.86 COLON-ALIGNED HELP
          ...
          SIZE 13 BY .92
          FONT 14
     button-grpid AT ROW 13.25 COL 29.14 HELP WIDGET-ID 2
          "Select group ID."
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 6, "endIndex": 73, "scopes": ["source.abl", "comment.block.abl", "comment"] },  // ' DEFINE FRAME statement is approaching 4K Bytes.  Breaking it up   '
      { "startIndex": 73, "endIndex": 75, "scopes": ["source.abl", "comment.block.abl"] }  // '*/'
    ],
    [
    ...
    [
      ...
      { "startIndex": 5, "endIndex": 13, "scopes": ["source.abl", "meta.define.abl", "variable.other.abl"] },  // 'bups-loc'
      ...
      { "startIndex": 21, "endIndex": 26, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '12.29'
      ...
      { "startIndex": 31, "endIndex": 33, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '55'
    ...
    [
      { "startIndex": 0, "endIndex": 5, "scopes": ["source.abl", "meta.define.abl"] },  // '     '
      { "startIndex": 5, "endIndex": 18, "scopes": ["source.abl", "meta.define.abl", "variable.other.abl"] },  // 'Scr-sales-loc'
      ...
      { "startIndex": 25, "endIndex": 26, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 26, "endIndex": 31, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '12.29'
      { "startIndex": 31, "endIndex": 32, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      ...
      { "startIndex": 36, "endIndex": 38, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '71'
    ...
    [
      { "startIndex": 0, "endIndex": 5, "scopes": ["source.abl", "meta.define.abl"] },  // '     '
      { "startIndex": 5, "endIndex": 15, "scopes": ["source.abl", "meta.define.abl", "variable.other.abl"] },  // 'bsales-loc'
      ...
      { "startIndex": 23, "endIndex": 28, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '12.25'
      ...
      { "startIndex": 33, "endIndex": 35, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '77'
      { "startIndex": 35, "endIndex": 36, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
    ...
    [
      { "startIndex": 0, "endIndex": 5, "scopes": ["source.abl", "meta.define.abl"] },  // '     '
      { "startIndex": 5, "endIndex": 22, "scopes": ["source.abl", "meta.define.abl", "storage.data.table.abl"] },  // 'custname.group-id'
      { "startIndex": 22, "endIndex": 23, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      ...
      { "startIndex": 30, "endIndex": 35, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '13.29'
      { "startIndex": 35, "endIndex": 36, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      ...
      { "startIndex": 40, "endIndex": 45, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '13.86'
    ...
    [
      ...
      { "startIndex": 15, "endIndex": 17, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '13'
      { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 18, "endIndex": 20, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'BY'
      { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 21, "endIndex": 24, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] }  // '.92'
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl", "meta.define.abl"] },  // '          '
    ...
    [
      { "startIndex": 0, "endIndex": 5, "scopes": ["source.abl", "meta.define.abl"] },  // '     '
      { "startIndex": 5, "endIndex": 17, "scopes": ["source.abl", "meta.define.abl", "variable.other.abl"] },  // 'button-grpid'
      { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 18, "endIndex": 20, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'AT'
      { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      ...
      { "startIndex": 25, "endIndex": 30, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '13.25'
      { "startIndex": 30, "endIndex": 31, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 31, "endIndex": 34, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'COL'
      { "startIndex": 34, "endIndex": 35, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 35, "endIndex": 40, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '29.14'
      { "startIndex": 40, "endIndex": 41, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 41, "endIndex": 45, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'HELP'
      { "startIndex": 45, "endIndex": 46, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 46, "endIndex": 55, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'WIDGET-ID'
      { "startIndex": 55, "endIndex": 56, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 56, "endIndex": 57, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] }  // '2'
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl", "meta.define.abl"] },  // '          '
      { "startIndex": 10, "endIndex": 11, "scopes": ["source.abl", "meta.define.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
    ...
    [
      { "startIndex": 0, "endIndex": 5, "scopes": ["source.abl", "meta.define.abl"] },  // '     '
      { "startIndex": 5, "endIndex": 24, "scopes": ["source.abl", "meta.define.abl", "storage.data.table.abl"] },  // 'custname.agent-code'
      { "startIndex": 24, "endIndex": 25, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 25, "endIndex": 27, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'AT'
      { "startIndex": 27, "endIndex": 28, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 28, "endIndex": 31, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'ROW'
      { "startIndex": 31, "endIndex": 32, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 32, "endIndex": 37, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '14.29'
      { "startIndex": 37, "endIndex": 38, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 38, "endIndex": 41, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'COL'
      { "startIndex": 41, "endIndex": 42, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 42, "endIndex": 44, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '71'
      { "startIndex": 44, "endIndex": 45, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 45, "endIndex": 58, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'COLON-ALIGNED'
      { "startIndex": 58, "endIndex": 59, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 59, "endIndex": 63, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] }  // 'HELP'
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl", "meta.define.abl"] },  // '          '
      { "startIndex": 10, "endIndex": 11, "scopes": ["source.abl", "meta.define.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
    ...
    [
      ...
      { "startIndex": 10, "endIndex": 14, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'SIZE'
      { "startIndex": 14, "endIndex": 15, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 15, "endIndex": 16, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '9'
      { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 17, "endIndex": 19, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'BY'
      { "startIndex": 19, "endIndex": 20, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 20, "endIndex": 23, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] }  // '.92'
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl", "meta.define.abl"] },  // '          '
      { "startIndex": 10, "endIndex": 14, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'FONT'
    ...
    [
      ...
      { "startIndex": 9, "endIndex": 10, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '1'
      { "startIndex": 10, "endIndex": 11, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 11, "endIndex": 15, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'DOWN'
      { "startIndex": 15, "endIndex": 16, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 16, "endIndex": 22, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'NO-BOX'
      { "startIndex": 22, "endIndex": 23, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 23, "endIndex": 37, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'KEEP-TAB-ORDER'
      { "startIndex": 37, "endIndex": 38, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 38, "endIndex": 45, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] }  // 'OVERLAY'
    ],
    [
      { "startIndex": 0, "endIndex": 9, "scopes": ["source.abl", "meta.define.abl"] },  // '         '
      { "startIndex": 9, "endIndex": 20, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'PAGE-BOTTOM'
      { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 21, "endIndex": 32, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'SIDE-LABELS'
      { "startIndex": 32, "endIndex": 33, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 33, "endIndex": 40, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] }  // 'THREE-D'
    ],
    [
      { "startIndex": 0, "endIndex": 9, "scopes": ["source.abl", "meta.define.abl"] },  // '         '
      { "startIndex": 9, "endIndex": 11, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'AT'
      { "startIndex": 11, "endIndex": 12, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 12, "endIndex": 15, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'COL'
      { "startIndex": 15, "endIndex": 16, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '1'
      { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 18, "endIndex": 21, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'ROW'
      { "startIndex": 21, "endIndex": 22, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 22, "endIndex": 23, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] }  // '1'
    ],
    [
      { "startIndex": 0, "endIndex": 9, "scopes": ["source.abl", "meta.define.abl"] },  // '         '
      { "startIndex": 9, "endIndex": 13, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'SIZE'
      { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 14, "endIndex": 19, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '91.72'
      { "startIndex": 19, "endIndex": 20, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 20, "endIndex": 22, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'BY'
      { "startIndex": 22, "endIndex": 23, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 23, "endIndex": 28, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] }  // '23.33'
    ],
    [
      { "startIndex": 0, "endIndex": 9, "scopes": ["source.abl", "meta.define.abl"] },  // '         '
      { "startIndex": 9, "endIndex": 13, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'FONT'
      { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 14, "endIndex": 15, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '8'
...
describe('', () => {
  let statement = `DEFINE FRAME Dialog-Frame
     rsChoice
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 13, "endIndex": 25, "scopes": ["source.abl", "meta.define.abl", "variable.other.abl"] }  // 'Dialog-Frame'
    ],
    [
      { "startIndex": 0, "endIndex": 5, "scopes": ["source.abl", "meta.define.abl"] },  // '     '
      { "startIndex": 5, "endIndex": 13, "scopes": ["source.abl", "meta.define.abl", "variable.other.abl"] }  // 'rsChoice'
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl", "meta.define.abl"] },  // '          '
      { "startIndex": 10, "endIndex": 11, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "punctuation.definition.preprocessor.abl"] },  // '&'
      { "startIndex": 11, "endIndex": 13, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "keyword.control.directive.conditional.abl"] },  // 'IF'
      { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      ...
      { "startIndex": 44, "endIndex": 48, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "keyword.control.directive.conditional.abl"] },  // 'THEN'
      ...
      { "startIndex": 52, "endIndex": 55, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'ROW'
      { "startIndex": 55, "endIndex": 56, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 56, "endIndex": 57, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '2'
      { "startIndex": 57, "endIndex": 58, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 58, "endIndex": 61, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'COL'
      { "startIndex": 61, "endIndex": 62, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 62, "endIndex": 63, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] }  // '2'
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl", "meta.define.abl"] },  // '          '
      { "startIndex": 10, "endIndex": 11, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "punctuation.definition.preprocessor.abl"] },  // '&'
      { "startIndex": 11, "endIndex": 15, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "keyword.control.directive.conditional.abl"] },  // 'ELSE'
      { "startIndex": 15, "endIndex": 16, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 16, "endIndex": 18, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'AT'
      { "startIndex": 18, "endIndex": 19, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 19, "endIndex": 22, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'ROW'
      { "startIndex": 22, "endIndex": 23, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 23, "endIndex": 27, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '1.71'
      { "startIndex": 27, "endIndex": 28, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 28, "endIndex": 31, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'COL'
      { "startIndex": 31, "endIndex": 32, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 32, "endIndex": 33, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '3'
      { "startIndex": 33, "endIndex": 34, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 34, "endIndex": 35, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "punctuation.definition.preprocessor.abl"] },  // '&'
      { "startIndex": 35, "endIndex": 40, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "keyword.control.directive.conditional.abl"] },  // 'ENDIF'
      { "startIndex": 40, "endIndex": 41, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 41, "endIndex": 49, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] }  // 'NO-LABEL'
    ],
    [
      { "startIndex": 0, "endIndex": 5, "scopes": ["source.abl", "meta.define.abl"] },  // '     '
      { "startIndex": 5, "endIndex": 6, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "punctuation.definition.preprocessor.abl"] },  // '&'
      { "startIndex": 6, "endIndex": 8, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "keyword.control.directive.conditional.abl"] },  // 'IF'
      { "startIndex": 8, "endIndex": 9, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      ...
      { "startIndex": 38, "endIndex": 39, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 39, "endIndex": 40, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "punctuation.definition.preprocessor.abl"] },  // '&'
      { "startIndex": 40, "endIndex": 44, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "keyword.control.directive.conditional.abl"] }  // 'THEN'
    ],
    [
      { "startIndex": 0, "endIndex": 7, "scopes": ["source.abl", "meta.define.abl"] },  // '       '
      { "startIndex": 7, "endIndex": 14, "scopes": ["source.abl", "meta.define.abl", "variable.other.abl"] },  // 'btnHelp'
      { "startIndex": 14, "endIndex": 15, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 15, "endIndex": 17, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'AT'
      { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 18, "endIndex": 21, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'ROW'
      { "startIndex": 21, "endIndex": 22, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 22, "endIndex": 26, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '6.38'
      { "startIndex": 26, "endIndex": 27, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 27, "endIndex": 30, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'COL'
      { "startIndex": 30, "endIndex": 31, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 31, "endIndex": 33, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] }  // '52'
    ],
    [
      { "startIndex": 0, "endIndex": 7, "scopes": ["source.abl", "meta.define.abl"] },  // '       '
      { "startIndex": 7, "endIndex": 13, "scopes": ["source.abl", "meta.define.abl", "variable.other.abl"] },  // 'RECT-2'
      { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 14, "endIndex": 16, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'AT'
      { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 17, "endIndex": 20, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'ROW'
      { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 21, "endIndex": 25, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '6.14'
      { "startIndex": 25, "endIndex": 26, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 26, "endIndex": 29, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'COL'
      { "startIndex": 29, "endIndex": 30, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 30, "endIndex": 33, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] }  // '2.4'
    ],
    [
      { "startIndex": 0, "endIndex": 5, "scopes": ["source.abl", "meta.define.abl"] },  // '     '
      { "startIndex": 5, "endIndex": 6, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "punctuation.definition.preprocessor.abl"] },  // '&'
      { "startIndex": 6, "endIndex": 11, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "keyword.control.directive.conditional.abl"] }  // 'ENDIF'
    ],
    [
      { "startIndex": 0, "endIndex": 5, "scopes": ["source.abl", "meta.define.abl"] },  // '     '
      { "startIndex": 5, "endIndex": 10, "scopes": ["source.abl", "meta.define.abl", "support.function.abl"] },  // 'SPACE'
      { "startIndex": 10, "endIndex": 11, "scopes": ["source.abl", "meta.define.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 11, "endIndex": 15, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '1.19'
      { "startIndex": 15, "endIndex": 16, "scopes": ["source.abl", "meta.define.abl", "meta.brace.round.abl"] },  // ')'
      { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 17, "endIndex": 21, "scopes": ["source.abl", "meta.define.abl", "support.function.abl"] },  // 'SKIP'
      { "startIndex": 21, "endIndex": 22, "scopes": ["source.abl", "meta.define.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 22, "endIndex": 26, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '0.28'
      { "startIndex": 26, "endIndex": 27, "scopes": ["source.abl", "meta.define.abl", "meta.brace.round.abl"] }  // ')'
    ],
    [
      { "startIndex": 0, "endIndex": 4, "scopes": ["source.abl", "meta.define.abl"] },  // '    '
      { "startIndex": 4, "endIndex": 8, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'WITH'
      { "startIndex": 8, "endIndex": 9, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 9, "endIndex": 16, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'VIEW-AS'
      { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 17, "endIndex": 27, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'DIALOG-BOX'
      { "startIndex": 27, "endIndex": 28, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 28, "endIndex": 42, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'KEEP-TAB-ORDER'
      { "startIndex": 42, "endIndex": 43, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 43, "endIndex": 57, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'DEFAULT-BUTTON'
      { "startIndex": 57, "endIndex": 58, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 58, "endIndex": 63, "scopes": ["source.abl", "meta.define.abl", "entity.name.type.abl"] }  // 'btnOk'
    ],
    [
      { "startIndex": 0, "endIndex": 9, "scopes": ["source.abl", "meta.define.abl"] },  // '         '
      { "startIndex": 9, "endIndex": 20, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'SIDE-LABELS'
      { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 21, "endIndex": 33, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'NO-UNDERLINE'
      { "startIndex": 33, "endIndex": 34, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 34, "endIndex": 41, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'THREE-D'
      { "startIndex": 41, "endIndex": 42, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 42, "endIndex": 52, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'SCROLLABLE'
      { "startIndex": 52, "endIndex": 53, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 53, "endIndex": 61, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] }  // 'CENTERED'
    ],
    [
      { "startIndex": 0, "endIndex": 9, "scopes": ["source.abl", "meta.define.abl"] },  // '         '
      { "startIndex": 9, "endIndex": 14, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'TITLE'
      { "startIndex": 14, "endIndex": 15, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 15, "endIndex": 22, "scopes": ["source.abl", "meta.define.abl", "entity.name.type.abl"] },  // 'gcTitle'
