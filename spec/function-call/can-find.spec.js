...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 3, "endIndex": 6, "scopes": ["source.abl", "keyword.operator.abl"] },  // 'NOT'
      ...
      { "startIndex": 73, "endIndex": 74, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
    ...
    [
      ...
      { "startIndex": 36, "endIndex": 37, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 12, "endIndex": 14, "scopes": ["source.abl", "keyword.other.abl"] },  // 'IF'
    { "startIndex": 14, "endIndex": 15, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 15, "endIndex": 23, "scopes": ["source.abl", "support.function.abl"] },  // 'CAN-FIND'
    { "startIndex": 23, "endIndex": 24, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 24, "endIndex": 29, "scopes": ["source.abl", "keyword.other.abl"] },  // 'FIRST'
    { "startIndex": 29, "endIndex": 30, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 30, "endIndex": 48, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'dictdb._Field-trig'
    { "startIndex": 48, "endIndex": 49, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 49, "endIndex": 51, "scopes": ["source.abl", "keyword.other.abl"] },  // 'OF'
    { "startIndex": 51, "endIndex": 52, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 52, "endIndex": 58, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'bField'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 7, "endIndex": 15, "scopes": ["source.abl", "support.function.abl"] },  // 'CAN-FIND'
    { "startIndex": 15, "endIndex": 16, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 16, "endIndex": 21, "scopes": ["source.abl", "keyword.other.abl"] },  // 'FIRST'
    { "startIndex": 21, "endIndex": 22, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 22, "endIndex": 41, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'DICTDB._Index-field'
    { "startIndex": 41, "endIndex": 42, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 42, "endIndex": 44, "scopes": ["source.abl", "keyword.other.abl"] },  // 'OF'
    { "startIndex": 44, "endIndex": 45, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 45, "endIndex": 58, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'DICTDB._Field'
    { "startIndex": 58, "endIndex": 59, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 49, "endIndex": 50, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 50, "endIndex": 52, "scopes": ["source.abl", "keyword.operator.abl"] },  // 'eq'
...
then.`;
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 37, "endIndex": 38, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 38, "endIndex": 40, "scopes": ["source.abl", "keyword.operator.abl"] },  // 'eq'
...
describe('', () => {
  let statement = `if can-find(salesrep where salesrep.quota[4] eq 100 then. `;
  let expectedTokens = [
    { "startIndex": 0, "endIndex": 2, "scopes": ["source.abl", "keyword.other.abl"] },  // 'if'
    { "startIndex": 2, "endIndex": 3, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 3, "endIndex": 11, "scopes": ["source.abl", "support.function.abl"] },  // 'can-find'
    { "startIndex": 11, "endIndex": 12, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 12, "endIndex": 20, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'salesrep'
    { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 21, "endIndex": 26, "scopes": ["source.abl", "keyword.other.abl"] },  // 'where'
    { "startIndex": 26, "endIndex": 27, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 27, "endIndex": 41, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'salesrep.quota'
    { "startIndex": 41, "endIndex": 42, "scopes": ["source.abl", "meta.array.literal.abl", "punctuation.definition.bracket.square.begin.abl"] },  // '['
    { "startIndex": 42, "endIndex": 43, "scopes": ["source.abl", "meta.array.literal.abl", "constant.numeric.abl"] },  // '4'
    { "startIndex": 43, "endIndex": 44, "scopes": ["source.abl", "meta.array.literal.abl", "punctuation.definition.bracket.square.end.abl"] },  // ']'
    { "startIndex": 44, "endIndex": 45, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 45, "endIndex": 47, "scopes": ["source.abl", "keyword.operator.abl"] },  // 'eq'
    { "startIndex": 47, "endIndex": 48, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 48, "endIndex": 51, "scopes": ["source.abl", "constant.numeric.abl"] },  // '100'
    { "startIndex": 51, "endIndex": 52, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 52, "endIndex": 56, "scopes": ["source.abl", "keyword.other.abl"] },  // 'then'
...
describe('', () => {
  let statement = `if can-find(salesrep where salesrep.quota[iMonth] eq 100 then. `;
  let expectedTokens = [
    { "startIndex": 0, "endIndex": 2, "scopes": ["source.abl", "keyword.other.abl"] },  // 'if'
    { "startIndex": 2, "endIndex": 3, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 3, "endIndex": 11, "scopes": ["source.abl", "support.function.abl"] },  // 'can-find'
    ...
    { "startIndex": 27, "endIndex": 41, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'salesrep.quota'
    { "startIndex": 41, "endIndex": 42, "scopes": ["source.abl", "meta.array.literal.abl", "punctuation.definition.bracket.square.begin.abl"] },  // '['
    { "startIndex": 42, "endIndex": 48, "scopes": ["source.abl", "meta.array.literal.abl", "variable.other.abl"] },  // 'iMonth'
    { "startIndex": 48, "endIndex": 49, "scopes": ["source.abl", "meta.array.literal.abl", "punctuation.definition.bracket.square.end.abl"] },  // ']'
    { "startIndex": 49, "endIndex": 50, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 50, "endIndex": 52, "scopes": ["source.abl", "keyword.operator.abl"] },  // 'eq'
    { "startIndex": 52, "endIndex": 53, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 53, "endIndex": 56, "scopes": ["source.abl", "constant.numeric.abl"] },  // '100'
    { "startIndex": 56, "endIndex": 57, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 57, "endIndex": 61, "scopes": ["source.abl", "keyword.other.abl"] },  // 'then'
