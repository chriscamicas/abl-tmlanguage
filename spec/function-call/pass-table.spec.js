...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 10, "endIndex": 15, "scopes": ["source.abl", "keyword.other.abl"] },  // 'table'
    { "startIndex": 15, "endIndex": 16, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 16, "endIndex": 25, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'copytable'
    { "startIndex": 25, "endIndex": 26, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 26, "endIndex": 38, "scopes": ["source.abl", "keyword.other.abl"] },  // 'by-reference'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 12, "endIndex": 19, "scopes": ["source.abl", "keyword.other.abl"] },  // 'dataset'
    { "startIndex": 19, "endIndex": 20, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 20, "endIndex": 26, "scopes": ["source.abl", "storage.data.dataset.abl"] },  // 'dsData'
    { "startIndex": 26, "endIndex": 27, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 27, "endIndex": 39, "scopes": ["source.abl", "keyword.other.abl"] },  // 'by-reference'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 8, "endIndex": 13, "scopes": ["source.abl", "keyword.other.abl"] },  // 'input'
    { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 14, "endIndex": 15, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 15, "endIndex": 22, "scopes": ["source.abl", "keyword.other.abl"] },  // 'dataset'
    { "startIndex": 22, "endIndex": 23, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 23, "endIndex": 33, "scopes": ["source.abl", "storage.data.dataset.abl"] },  // 'dsCustomer'
    { "startIndex": 33, "endIndex": 34, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
    { "startIndex": 34, "endIndex": 40, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'handle'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 18, "endIndex": 29, "scopes": ["source.abl", "support.function.abl"] },  // 'buffer-copy'
    { "startIndex": 29, "endIndex": 30, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 30, "endIndex": 36, "scopes": ["source.abl", "keyword.other.abl"] },  // 'buffer'
    { "startIndex": 36, "endIndex": 37, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 37, "endIndex": 45, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'Customer'
    { "startIndex": 45, "endIndex": 46, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
    { "startIndex": 46, "endIndex": 52, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'handle'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 8, "endIndex": 13, "scopes": ["source.abl", "keyword.other.abl"] },  // 'input'
    { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 14, "endIndex": 20, "scopes": ["source.abl", "keyword.other.abl"] },  // 'buffer'
    { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 21, "endIndex": 29, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'Customer'
    { "startIndex": 29, "endIndex": 30, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
    { "startIndex": 30, "endIndex": 36, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'handle'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 8, "endIndex": 13, "scopes": ["source.abl", "keyword.other.abl"] },  // 'input'
    { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 14, "endIndex": 24, "scopes": ["source.abl", "keyword.other.abl"] },  // 'temp-table'
    { "startIndex": 24, "endIndex": 25, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 25, "endIndex": 35, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'ttCustomer'
    { "startIndex": 35, "endIndex": 36, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
    { "startIndex": 36, "endIndex": 42, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'handle'
