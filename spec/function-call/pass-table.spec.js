...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 33, "endIndex": 34, "scopes": ["source.abl", "meta.function.arguments.abl", "punctuation.accessor.abl"] },  // ':'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 45, "endIndex": 46, "scopes": ["source.abl", "meta.function.arguments.abl", "punctuation.accessor.abl"] },  // ':'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 29, "endIndex": 30, "scopes": ["source.abl", "meta.function.arguments.abl", "punctuation.accessor.abl"] },  // ':'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 35, "endIndex": 36, "scopes": ["source.abl", "meta.function.arguments.abl", "punctuation.accessor.abl"] },  // ':'
