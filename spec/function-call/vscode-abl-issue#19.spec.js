...
trim(c_test)`;
    ...
    let expectedTokens = [
        [
            ...
            {"startIndex":8,"endIndex":14,"scopes":["source.abl","meta.define.abl","variable.other.abl"]},
            {"startIndex":14,"endIndex":15,"scopes":["source.abl","meta.define.abl"]},
            {"startIndex":15,"endIndex":17,"scopes":["source.abl","meta.define.abl","keyword.other.abl"]},
            {"startIndex":17,"endIndex":18,"scopes":["source.abl","meta.define.abl"]},
            {"startIndex":18,"endIndex":22,"scopes":["source.abl","meta.define.abl","storage.type.abl"]},
            {"startIndex":22,"endIndex":23,"scopes":["source.abl","meta.define.abl"]},
            {"startIndex":23,"endIndex":30,"scopes":["source.abl","meta.define.abl","keyword.other.abl"]},
