...
trim(c_test)`;
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 8, "endIndex": 14, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl", "variable.other.abl"] },  // 'c_test'
      { "startIndex": 14, "endIndex": 15, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl"] },  // ' '
      { "startIndex": 15, "endIndex": 17, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl", "keyword.other.abl"] },  // 'as'
      { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl"] },  // ' '
      { "startIndex": 18, "endIndex": 22, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl", "storage.type.abl"] },  // 'char'
      { "startIndex": 22, "endIndex": 23, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl"] },  // ' '
      { "startIndex": 23, "endIndex": 30, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl", "keyword.other.abl"] },  // 'no-undo'
      ...
      { "startIndex": 24, "endIndex": 25, "scopes": ["source.abl", "support.function.abl"] },  // ':u'
      { "startIndex": 25, "endIndex": 26, "scopes": ["source.abl", "punctuation.terminator.abl"] }  // '.'
    ], [
      { "startIndex": 0, "endIndex": 4, "scopes": ["source.abl", "meta.function-call.abl", "entity.name.function.abl"] }, // 'trim'
      { "startIndex": 4, "endIndex": 5, "scopes": ["source.abl", "meta.function-call.abl", "meta.brace.round.js"] },  // '('
      { "startIndex": 5, "endIndex": 11, "scopes": ["source.abl", "meta.function-call.abl", "variable.other.abl"] },  // 'c_test'
...
trim( c_test)`;
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 6, "endIndex": 12, "scopes": ["source.abl", "meta.function-call.abl", "variable.other.abl"] },  // 'c_test'
