...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 62, "endIndex": 63, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
    { "startIndex": 63, "endIndex": 71, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'DVWebKey'
    { "startIndex": 71, "endIndex": 72, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
    { "startIndex": 72, "endIndex": 74, "scopes": ["source.abl", "string.quoted.double.abl", "support.other.abl"] },  // ':U'
