...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 11, "endIndex": 15, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'data'
    ...
    { "startIndex": 17, "endIndex": 36, "scopes": ["source.abl", "variable.other.abl"] },  // 'output-content-type'
...
find b1-cust exclusive-lock where rowid(b1-cust) = rowid(customer) no-wait no-error.`;
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 49, "endIndex": 50, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
