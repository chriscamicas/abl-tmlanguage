...
SessionManager:ContextDataset:WRITE-XML ( "longchar":U,
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 30, "endIndex": 39, "scopes": ["source.abl", "support.function.abl"] },  // 'WRITE-XML'
      ...
      { "startIndex": 42, "endIndex": 43, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
      { "startIndex": 43, "endIndex": 51, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'longchar'
      { "startIndex": 51, "endIndex": 52, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
      { "startIndex": 52, "endIndex": 54, "scopes": ["source.abl", "string.quoted.double.abl", "support.other.abl"] },  // ':U'
      { "startIndex": 54, "endIndex": 55, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 42, "scopes": ["source.abl"] },  // '                                          '
      { "startIndex": 42, "endIndex": 51, "scopes": ["source.abl", "variable.other.abl"] },  // 'lcDataset'
      { "startIndex": 51, "endIndex": 52, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 42, "scopes": ["source.abl"] },  // '                                          '
      { "startIndex": 42, "endIndex": 43, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
      { "startIndex": 43, "endIndex": 48, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'EMPTY'
      ...
      { "startIndex": 53, "endIndex": 54, "scopes": ["source.abl", "constant.language.abl"] },  // '?'
      { "startIndex": 54, "endIndex": 55, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      { "startIndex": 55, "endIndex": 56, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 56, "endIndex": 57, "scopes": ["source.abl", "constant.language.abl"] },  // '?'
...
SessionManager:ContextDataset:READ-XML ( "longchar":U,
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 42, "endIndex": 50, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'longchar'
      { "startIndex": 50, "endIndex": 51, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
      { "startIndex": 51, "endIndex": 53, "scopes": ["source.abl", "string.quoted.double.abl", "support.other.abl"] },  // ':U'
      { "startIndex": 53, "endIndex": 54, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 42, "scopes": ["source.abl"] },  // '                                          '
      { "startIndex": 42, "endIndex": 51, "scopes": ["source.abl", "variable.other.abl"] },  // 'lcDataset'
