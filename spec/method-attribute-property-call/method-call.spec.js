...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 62, "endIndex": 74, "scopes": ["source.abl", "keyword.other.abl"] },  // 'input-output'
      { "startIndex": 74, "endIndex": 75, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 75, "endIndex": 85, "scopes": ["source.abl", "variable.other.abl"] },  // 'oOperation'
      { "startIndex": 85, "endIndex": 86, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 4, "scopes": ["source.abl"] },  // '    '
      { "startIndex": 4, "endIndex": 16, "scopes": ["source.abl", "keyword.other.abl"] },  // 'input-output'
      { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 17, "endIndex": 23, "scopes": ["source.abl", "variable.other.abl"] },  // 'oArray'
      { "startIndex": 23, "endIndex": 24, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 4, "scopes": ["source.abl"] },  // '    '
      { "startIndex": 4, "endIndex": 16, "scopes": ["source.abl", "keyword.other.abl"] },  // 'input-output'
      { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 17, "endIndex": 31, "scopes": ["source.abl", "variable.other.abl"] },  // 'poDocumentRoot'
      { "startIndex": 31, "endIndex": 32, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 4, "scopes": ["source.abl"] },  // '    '
      { "startIndex": 4, "endIndex": 16, "scopes": ["source.abl", "variable.other.abl"] },  // 'poRestMethod'
      { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 4, "scopes": ["source.abl"] },  // '    '
      { "startIndex": 4, "endIndex": 16, "scopes": ["source.abl", "variable.other.abl"] },  // 'pcParameters'
      { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 4, "scopes": ["source.abl"] },  // '    '
      { "startIndex": 4, "endIndex": 26, "scopes": ["source.abl", "variable.other.abl"] },  // 'oParameterDescriptions'
...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 29, "endIndex": 30, "scopes": ["source.abl", "meta.define.method.abl", "meta.brace.round.abl"] },  // '('
      ...
      { "startIndex": 51, "endIndex": 52, "scopes": ["source.abl", "meta.define.method.abl", "meta.brace.round.abl"] },  // ')'
    ...
    [
      ...
      { "startIndex": 12, "endIndex": 17, "scopes": ["source.abl", "keyword.other.abl"] },  // 'table'
      { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 18, "endIndex": 27, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'copytable'
      { "startIndex": 27, "endIndex": 28, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 28, "endIndex": 40, "scopes": ["source.abl", "keyword.other.abl"] },  // 'by-reference'
      { "startIndex": 40, "endIndex": 41, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      { "startIndex": 41, "endIndex": 42, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
      { "startIndex": 42, "endIndex": 43, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
      { "startIndex": 43, "endIndex": 44, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      { "startIndex": 44, "endIndex": 45, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
      { "startIndex": 45, "endIndex": 46, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 43, "endIndex": 50, "scopes": ["source.abl", "keyword.other.abl"] },  // 'DATASET'
      { "startIndex": 50, "endIndex": 51, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 51, "endIndex": 66, "scopes": ["source.abl", "storage.data.dataset.abl"] },  // 'dsAccessRequest'
      { "startIndex": 66, "endIndex": 67, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
    ...
    [
      ...
      { "startIndex": 7, "endIndex": 8, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      ...
      { "startIndex": 20, "endIndex": 27, "scopes": ["source.abl", "keyword.other.abl"] },  // 'DATASET'
      { "startIndex": 27, "endIndex": 28, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 28, "endIndex": 43, "scopes": ["source.abl", "storage.data.dataset.abl"] },  // 'dsAccessRequest'
    ...
    [
      ...
      { "startIndex": 15, "endIndex": 16, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      { "startIndex": 16, "endIndex": 34, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'ThrowDatasetErrors'
      { "startIndex": 34, "endIndex": 35, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 35, "endIndex": 42, "scopes": ["source.abl", "keyword.other.abl"] },  // 'DATASET'
      { "startIndex": 42, "endIndex": 43, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 43, "endIndex": 58, "scopes": ["source.abl", "storage.data.dataset.abl"] },  // 'dsAccessRequest'
      { "startIndex": 58, "endIndex": 59, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      { "startIndex": 59, "endIndex": 65, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'HANDLE'
...
Progress.Lang.Class:GetClass (pcEntityName) :IsA ( "Consultingwerk.SmartFramework.SmartBusinessEntity":U) eq false) then
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 50, "endIndex": 51, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 51, "endIndex": 52, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    ...
    [
      ...
      { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      ...
      { "startIndex": 43, "endIndex": 44, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
      { "startIndex": 44, "endIndex": 45, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      { "startIndex": 45, "endIndex": 48, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'IsA'
      { "startIndex": 48, "endIndex": 49, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 49, "endIndex": 50, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 50, "endIndex": 51, "scopes": ["source.abl"] },  // ' '
      ...
      { "startIndex": 90, "endIndex": 91, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
    ...
    [
      ...
      { "startIndex": 106, "endIndex": 108, "scopes": ["source.abl", "keyword.operator.abl"] },  // 'eq'
      { "startIndex": 108, "endIndex": 109, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 109, "endIndex": 114, "scopes": ["source.abl", "constant.language.abl"] },  // 'false'
      { "startIndex": 114, "endIndex": 115, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
    ...
    [
      ...
      { "startIndex": 55, "endIndex": 56, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 56, "endIndex": 63, "scopes": ["source.abl", "variable.other.abl"] },  // 'oMethod'
