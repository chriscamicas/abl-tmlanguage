...
hSrv:connect('-URL http://localhost:1234/apsv').`;
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 5, "endIndex": 12, "scopes": ["source.abl", "support.function.abl"] },  // 'connect'
      { "startIndex": 12, "endIndex": 13, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl", "string.quoted.single.abl", "punctuation.definition.string.begin.abl"] },  // '''
      { "startIndex": 14, "endIndex": 45, "scopes": ["source.abl", "string.quoted.single.abl"] },  // '-URL http://localhost:1234/apsv'
      { "startIndex": 45, "endIndex": 46, "scopes": ["source.abl", "string.quoted.single.abl", "punctuation.definition.string.end.abl"] },  // '''
