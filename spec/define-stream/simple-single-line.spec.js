...
describe('', () => {
    ...
    let expectedTokens = [
        ...
        { "startIndex": 7, "endIndex": 13, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },
        { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl", "meta.define.abl"] },
        { "startIndex": 14, "endIndex": 21, "scopes": ["source.abl", "meta.define.abl", "variable.other.abl"] },
...
describe('', () => {
    ...
    let expectedTokens = [
        ...
        { "startIndex": 7, "endIndex": 13, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },
        { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl", "meta.define.abl"] },
        { "startIndex": 14, "endIndex": 22, "scopes": ["source.abl", "meta.define.abl", "variable.other.abl"] },
