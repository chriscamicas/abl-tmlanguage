...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 6, "endIndex": 9, "scopes": ["source.abl", "constant.numeric.abl"] },  // '200'
      { "startIndex": 9, "endIndex": 10, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 10, "endIndex": 12, "scopes": ["source.abl", "keyword.operator.abl"] },  // '<='
      ...
      { "startIndex": 28, "endIndex": 29, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      ...
      { "startIndex": 59, "endIndex": 60, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      ...
      { "startIndex": 71, "endIndex": 72, "scopes": ["source.abl", "keyword.operator.abl"] },  // '<'
      { "startIndex": 72, "endIndex": 73, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 73, "endIndex": 76, "scopes": ["source.abl", "constant.numeric.abl"] },  // '300'
      { "startIndex": 76, "endIndex": 77, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
    ...
    [
      ...
      { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      { "startIndex": 18, "endIndex": 26, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'StartTls'
      { "startIndex": 26, "endIndex": 27, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 27, "endIndex": 38, "scopes": ["source.abl", "variable.other.abl"] },  // 'baseRequest'
      { "startIndex": 38, "endIndex": 39, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      { "startIndex": 39, "endIndex": 42, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'URI'
      { "startIndex": 42, "endIndex": 43, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      { "startIndex": 43, "endIndex": 47, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'Host'
    ...
    [
      ...
      { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      ...
      { "startIndex": 23, "endIndex": 33, "scopes": ["source.abl", "support.function.abl"] },  // 'substitute'
      { "startIndex": 33, "endIndex": 34, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 34, "endIndex": 35, "scopes": ["source.abl", "string.quoted.single.abl", "punctuation.definition.string.begin.abl"] },  // '''
      { "startIndex": 35, "endIndex": 69, "scopes": ["source.abl", "string.quoted.single.abl"] },  // 'Unable to create HTTP tunnel to &1'
      { "startIndex": 69, "endIndex": 70, "scopes": ["source.abl", "string.quoted.single.abl", "punctuation.definition.string.end.abl"] },  // '''
      { "startIndex": 70, "endIndex": 71, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      { "startIndex": 71, "endIndex": 72, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 72, "endIndex": 83, "scopes": ["source.abl", "variable.other.abl"] },  // 'baseRequest'
      { "startIndex": 83, "endIndex": 84, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      { "startIndex": 84, "endIndex": 87, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'URI'
      { "startIndex": 87, "endIndex": 88, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      { "startIndex": 88, "endIndex": 96, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'ToString'
      { "startIndex": 96, "endIndex": 97, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 97, "endIndex": 98, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
      { "startIndex": 98, "endIndex": 99, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 10, "endIndex": 11, "scopes": ["source.abl", "constant.numeric.abl"] },  // '1'
    { "startIndex": 11, "endIndex": 12, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
    { "startIndex": 12, "endIndex": 13, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 28, "endIndex": 39, "scopes": ["source.abl", "comment.block.abl", "comment"] },  // ' ticket-id '
      { "startIndex": 39, "endIndex": 41, "scopes": ["source.abl", "comment.block.abl"] },  // '*/'
    ...
    [
      ...
      { "startIndex": 15, "endIndex": 23, "scopes": ["source.abl", "variable.other.abl"] },  // 'hDataset'
    ...
    [
      ...
      { "startIndex": 12, "endIndex": 13, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      { "startIndex": 13, "endIndex": 26, "scopes": ["source.abl", "support.function.abl"] },  // 'EMPTY-DATASET'
      { "startIndex": 26, "endIndex": 27, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 6, "endIndex": 39, "scopes": ["source.abl", "comment.block.abl", "comment"] },  // ' Point to a valid window handle. '
      { "startIndex": 39, "endIndex": 41, "scopes": ["source.abl", "comment.block.abl"] }  // '*/'
    ],
    [
      { "startIndex": 0, "endIndex": 4, "scopes": ["source.abl"] },  // '    '
      ...
      { "startIndex": 19, "endIndex": 20, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
      { "startIndex": 21, "endIndex": 22, "scopes": ["source.abl"] },  // ' '
      ...
      { "startIndex": 39, "endIndex": 47, "scopes": ["source.abl", "variable.other.abl"] },  // 'p_Window'
    ...
    [
      ...
      { "startIndex": 43, "endIndex": 44, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 44, "endIndex": 58, "scopes": ["source.abl", "variable.language.abl"] },  // 'CURRENT-WINDOW'
...
( PlanWeight AND StockSearchToSearchWeightNet <= StockSearchBrokenUpWeightNet ) THEN message 123.`;
  let expectedTokens = [
    [
      { "startIndex": 0, "endIndex": 2, "scopes": ["source.abl", "keyword.other.abl"] },  // 'IF'
      { "startIndex": 2, "endIndex": 3, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 3, "endIndex": 4, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 4, "endIndex": 7, "scopes": ["source.abl", "keyword.operator.abl"] },  // 'NOT'
      ...
      { "startIndex": 49, "endIndex": 51, "scopes": ["source.abl", "keyword.operator.abl"] },  // '<='
      ...
      { "startIndex": 77, "endIndex": 78, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
      { "startIndex": 78, "endIndex": 79, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 79, "endIndex": 81, "scopes": ["source.abl", "keyword.other.abl"] }  // 'OR'
    ],
    [
      { "startIndex": 0, "endIndex": 1, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      ...
      { "startIndex": 46, "endIndex": 48, "scopes": ["source.abl", "keyword.operator.abl"] },  // '<='
      { "startIndex": 48, "endIndex": 49, "scopes": ["source.abl"] },  // ' '
      ...
      { "startIndex": 93, "endIndex": 96, "scopes": ["source.abl", "constant.numeric.abl"] },  // '123'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 43, "endIndex": 44, "scopes": ["source.abl", "keyword.operator.abl"] },  // '+'
      { "startIndex": 44, "endIndex": 45, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 45, "endIndex": 46, "scopes": ["source.abl", "constant.numeric.abl"] },  // '1'
...
END.`;
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 23, "endIndex": 24, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
