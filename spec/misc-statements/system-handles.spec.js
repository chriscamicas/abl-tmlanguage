...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 8, "endIndex": 22, "scopes": ["source.abl", "variable.language.abl"] },  // 'this-procedure'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 24, "endIndex": 35, "scopes": ["source.abl", "variable.language.abl"] },  // 'this-object'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 11, "endIndex": 22, "scopes": ["source.abl", "variable.language.abl"] },  // 'this-object'
    { "startIndex": 22, "endIndex": 23, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
    { "startIndex": 23, "endIndex": 24, "scopes": ["source.abl", "punctuation.terminator.abl"] }  // '.'
  ];
  shared.itShouldMatchExpectedScopes(statement, expectedTokens);
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 7, "endIndex": 10, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'Add'
    { "startIndex": 10, "endIndex": 11, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 11, "endIndex": 20, "scopes": ["source.abl", "variable.language.abl"] },  // 'file-info'
    { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
    { "startIndex": 21, "endIndex": 27, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'handle'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 12, "endIndex": 24, "scopes": ["source.abl", "support.function.abl"] },  // 'set-ROLLBACK'
