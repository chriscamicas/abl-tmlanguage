...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 25, "endIndex": 40, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'ENCODE-PASSWORD'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 9, "endIndex": 24, "scopes": ["source.abl", "variable.language.abl"] },  // 'security-policy'
    { "startIndex": 24, "endIndex": 25, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
    { "startIndex": 25, "endIndex": 42, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'validate-PASSWORD'
