...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 27, "endIndex": 28, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 23, "endIndex": 24, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
      { "startIndex": 24, "endIndex": 25, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 25, "endIndex": 26, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 26, "endIndex": 28, "scopes": ["source.abl", "keyword.other.abl"] },  // 'if'
      { "startIndex": 28, "endIndex": 29, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 29, "endIndex": 33, "scopes": ["source.abl", "constant.language.abl"] },  // 'true'
      ...
      { "startIndex": 39, "endIndex": 44, "scopes": ["source.abl", "constant.language.abl"] },  // 'false'
      ...
      { "startIndex": 50, "endIndex": 54, "scopes": ["source.abl", "constant.language.abl"] },  // 'true'
    ...
    [
      ...
      { "startIndex": 26, "endIndex": 27, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
    ...
    [
      ...
      { "startIndex": 18, "endIndex": 19, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 19, "endIndex": 20, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
    ...
    [
      ...
      { "startIndex": 22, "endIndex": 23, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
    ...
    [
      ...
      { "startIndex": 31, "endIndex": 32, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
      ...
      { "startIndex": 41, "endIndex": 45, "scopes": ["source.abl", "constant.language.abl"] },  // 'true'
    ...
    [
      ...
      { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
      { "startIndex": 21, "endIndex": 33, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'all the rage'
...
END CASE.  `;
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 26, "endIndex": 33, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'produit'
      { "startIndex": 33, "endIndex": 34, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
      { "startIndex": 34, "endIndex": 35, "scopes": ["source.abl", "meta.brace.round.abl"] }  // ')'
    ],
    [
      ...
      { "startIndex": 15, "endIndex": 16, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
      { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl"] },  // ' '
      ...
      { "startIndex": 27, "endIndex": 35, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'document'
    ...
    [
      ...
      { "startIndex": 30, "endIndex": 41, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'printerName'
    ...
    [
      ...
      { "startIndex": 14, "endIndex": 21, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'produit'
      ...
      { "startIndex": 23, "endIndex": 24, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 24, "endIndex": 31, "scopes": ["source.abl", "variable.other.abl"] },  // 'produit'
      { "startIndex": 31, "endIndex": 32, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 32, "endIndex": 33, "scopes": ["source.abl", "keyword.operator.abl"] },  // '+'
      { "startIndex": 33, "endIndex": 34, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 34, "endIndex": 40, "scopes": ["source.abl", "support.function.abl"] },  // 'string'
      { "startIndex": 40, "endIndex": 41, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 41, "endIndex": 44, "scopes": ["source.abl", "constant.numeric.abl"] },  // '0x3'
