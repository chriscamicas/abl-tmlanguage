...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 7, "endIndex": 8, "scopes": ["source.abl", "constant.numeric.abl"] },  // '1'
      ...
      { "startIndex": 29, "endIndex": 34, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'error'
      ...
      { "startIndex": 37, "endIndex": 45, "scopes": ["source.abl", "variable.other.abl"] },  // 'cLogLine'
    ...
    [
      ...
      { "startIndex": 2, "endIndex": 6, "scopes": ["source.abl", "keyword.other.abl"] },  // 'when'
      { "startIndex": 6, "endIndex": 7, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 7, "endIndex": 8, "scopes": ["source.abl", "constant.numeric.abl"] },  // '2'
      { "startIndex": 8, "endIndex": 9, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 9, "endIndex": 13, "scopes": ["source.abl", "keyword.other.abl"] },  // 'then'
      { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 14, "endIndex": 20, "scopes": ["source.abl", "variable.other.abl"] },  // 'Assert'
    ...
    [
      ...
      { "startIndex": 2, "endIndex": 6, "scopes": ["source.abl", "keyword.other.abl"] },  // 'when'
      { "startIndex": 6, "endIndex": 7, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 7, "endIndex": 8, "scopes": ["source.abl", "constant.numeric.abl"] },  // '3'
      { "startIndex": 8, "endIndex": 9, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 9, "endIndex": 13, "scopes": ["source.abl", "keyword.other.abl"] },  // 'then'
      { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 14, "endIndex": 20, "scopes": ["source.abl", "variable.other.abl"] },  // 'Assert'
