...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 13, "endIndex": 22, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'bCustomer'
    ...
    [
      ...
      { "startIndex": 18, "endIndex": 27, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'bCustomer'
      { "startIndex": 27, "endIndex": 28, "scopes": ["source.abl"] },  // ' '
...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 16, "endIndex": 32, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'sports.bCustomer'
      { "startIndex": 32, "endIndex": 33, "scopes": ["source.abl"] },  // ' '
    ...
    [
      ...
      { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 21, "endIndex": 34, "scopes": ["source.abl", "storage.data.table.abl"] },  // 's2k.bCustomer'
