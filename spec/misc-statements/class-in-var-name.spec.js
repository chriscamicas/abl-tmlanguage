...
END.`;
  let expectedTokens = [
    [
      ...
      { "startIndex": 8, "endIndex": 9, "scopes": ["source.abl", "meta.block.abl", "keyword.operator.abl"] },  // '='
      { "startIndex": 9, "endIndex": 10, "scopes": ["source.abl", "meta.block.abl"] },  // ' '
      { "startIndex": 10, "endIndex": 11, "scopes": ["source.abl", "meta.block.abl", "constant.numeric.abl"] },  // '1'
      ...
      { "startIndex": 27, "endIndex": 42, "scopes": ["source.abl", "meta.block.abl", "variable.other.abl"] },  // 'mc-g-list-class'
      { "startIndex": 42, "endIndex": 43, "scopes": ["source.abl", "meta.block.abl", "meta.brace.round.abl"] },  // ')'
    ...
    [
      ...
      { "startIndex": 39, "endIndex": 43, "scopes": ["source.abl", "variable.other.abl"] },  // 'mi-i'
      { "startIndex": 43, "endIndex": 44, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      { "startIndex": 44, "endIndex": 59, "scopes": ["source.abl", "variable.other.abl"] },  // 'mc-g-list-class'
    ...
    [
      ...
      { "startIndex": 38, "endIndex": 40, "scopes": ["source.abl", "keyword.operator.abl"] },  // '<='
    ...
    [
      ...
      { "startIndex": 55, "endIndex": 57, "scopes": ["source.abl", "keyword.operator.abl"] },  // '<>'
    ...
    [
      ...
      { "startIndex": 8, "endIndex": 30, "scopes": ["source.abl", "comment.block.abl", "comment"] },  // ' Keep only redemption '
      { "startIndex": 30, "endIndex": 32, "scopes": ["source.abl", "comment.block.abl"] }  // '*/'
    ],
    [
      { "startIndex": 0, "endIndex": 6, "scopes": ["source.abl"] },  // '	     '
      { "startIndex": 6, "endIndex": 8, "scopes": ["source.abl", "keyword.other.abl"] },  // 'IF'
      ...
      { "startIndex": 23, "endIndex": 25, "scopes": ["source.abl", "keyword.operator.abl"] },  // '<>'
    ...
    [
      ...
      { "startIndex": 16, "endIndex": 33, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'hist-trn.h-status'
      ...
      { "startIndex": 36, "endIndex": 41, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'P,W,C'
      ...
      { "startIndex": 46, "endIndex": 47, "scopes": ["source.abl", "constant.numeric.abl"] },  // '0'
