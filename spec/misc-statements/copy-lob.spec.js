...
no-error.`;
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "constant.numeric.abl"] },  // '4'
    ...
    [
      ...
      { "startIndex": 12, "endIndex": 14, "scopes": ["source.abl", "comment.block.abl"] },  // '/*'
      { "startIndex": 14, "endIndex": 49, "scopes": ["source.abl", "comment.block.abl", "comment"] },  // ' overlay at length( results ) +  1 '
      { "startIndex": 49, "endIndex": 51, "scopes": ["source.abl", "comment.block.abl"] },  // '*/'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 40, "endIndex": 41, "scopes": ["source.abl", "constant.numeric.abl"] },  // '4'
    ...
    { "startIndex": 60, "endIndex": 62, "scopes": ["source.abl", "comment.block.abl"] },  // '/*'
    { "startIndex": 62, "endIndex": 97, "scopes": ["source.abl", "comment.block.abl", "comment"] },  // ' overlay at length( results ) +  1 '
    { "startIndex": 97, "endIndex": 99, "scopes": ["source.abl", "comment.block.abl"] },  // '*/'
