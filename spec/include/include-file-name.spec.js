...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 24, "endIndex": 25, "scopes": ["source.abl", "meta.include.abl", "meta.include.argument.abl", "keyword.operator.abl"] },  // '='
...
`;
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 14, "endIndex": 15, "scopes": ["source.abl", "meta.include.abl", "meta.include.argument.abl", "keyword.operator.abl"] },  // '='
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 5, "endIndex": 6, "scopes": ["source.abl", "meta.include.abl", "meta.include.argument.abl", "keyword.operator.abl"] },  // '='
    ...
    [
      ...
      { "startIndex": 6, "endIndex": 7, "scopes": ["source.abl", "meta.include.abl", "meta.include.argument.abl", "keyword.operator.abl"] },  // '='
...
describe('', () => {
  ...
  */
  ...
  let expectedTokens = [
    ...
    [
      { "startIndex": 0, "endIndex": 2, "scopes": ["source.abl", "meta.include.abl"] },  // '  '
      { "startIndex": 2, "endIndex": 4, "scopes": ["source.abl", "meta.include.abl", "comment.block.abl"] }  // '/*'
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl", "meta.include.abl", "comment.block.abl", "comment"] }  // '  &int=13'
    ],
    [
      { "startIndex": 0, "endIndex": 11, "scopes": ["source.abl", "meta.include.abl", "comment.block.abl", "comment"] }  // '  &NEW=OLD'
    ],
    [
      { "startIndex": 0, "endIndex": 2, "scopes": ["source.abl", "meta.include.abl", "comment.block.abl", "comment"] },  // '  '
      { "startIndex": 2, "endIndex": 4, "scopes": ["source.abl", "meta.include.abl", "comment.block.abl"] }  // '*/'
    ],
    [
      { "startIndex": 0, "endIndex": 1, "scopes": ["source.abl", "meta.include.abl"] }  // ''
...
describe('UNC path, FQDN, and multiple dots in the filename', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 76, "endIndex": 77, "scopes": ["source.abl", "meta.include.abl", "meta.include.argument.abl", "keyword.operator.abl"] },  // '='
...
describe('UNC path, FQDN, and multiple dots in the quoted filename', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 78, "endIndex": 79, "scopes": ["source.abl", "meta.include.abl", "meta.include.argument.abl", "keyword.operator.abl"] },  // '='
