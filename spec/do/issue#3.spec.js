...
END.`;
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 3, "endIndex": 5, "scopes": ["source.abl", "meta.do.abl", "variable.other.abl"] },  // 'mI'
      ...
      { "startIndex": 8, "endIndex": 9, "scopes": ["source.abl", "meta.do.abl", "constant.numeric.source.abl"] },  // '1'
      { "startIndex": 9, "endIndex": 10, "scopes": ["source.abl", "meta.do.abl"] },
      { "startIndex": 10, "endIndex": 12, "scopes": ["source.abl", "meta.do.abl", "keyword.other.abl"] },  // ' TO '
      { "startIndex": 12, "endIndex": 13, "scopes": ["source.abl", "meta.do.abl"] },
      { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl", "meta.do.abl", "constant.numeric.source.abl"] },  // '3'
      ...
      { "startIndex": 6, "endIndex": 15, "scopes": ["source.abl", "meta.do.abl", "meta.do.body.abl", "comment.block.source.abl", "comment"] },  // ' comment '
