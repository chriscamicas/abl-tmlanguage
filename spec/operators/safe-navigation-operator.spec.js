...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 11, "endIndex": 13, "scopes": ["source.abl", "keyword.operator.abl"] },  // '?:'
    ...
    { "startIndex": 35, "endIndex": 36, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 11, "endIndex": 13, "scopes": ["source.abl", "keyword.operator.abl"] },  // '?:'
    { "startIndex": 13, "endIndex": 25, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'NewEventName'
    { "startIndex": 25, "endIndex": 27, "scopes": ["source.abl", "keyword.operator.abl"] },  // '?:'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 24, "endIndex": 26, "scopes": ["source.abl", "keyword.operator.abl"] },  // '?:'
    { "startIndex": 26, "endIndex": 35, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'Subscribe'
    { "startIndex": 35, "endIndex": 36, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 36, "endIndex": 55, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'NewEventNameHandler'
    { "startIndex": 55, "endIndex": 56, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 33, "endIndex": 42, "scopes": ["source.abl", "variable.other.abl"] },  // 'oVariable'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 32, "endIndex": 34, "scopes": ["source.abl", "keyword.operator.abl"] },  // '?:'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 18, "endIndex": 19, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
    { "startIndex": 19, "endIndex": 31, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'NewEventName'
    { "startIndex": 31, "endIndex": 33, "scopes": ["source.abl", "keyword.operator.abl"] },  // '?:'
    ...
    { "startIndex": 46, "endIndex": 47, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
...
describe('technically impossible but will pass the compiler', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 7, "endIndex": 8, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 8, "endIndex": 19, "scopes": ["source.abl", "variable.language.abl"] },  // 'this-object'
    { "startIndex": 19, "endIndex": 21, "scopes": ["source.abl", "keyword.operator.abl"] },  // '?:'
    { "startIndex": 21, "endIndex": 33, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'NewEventName'
    { "startIndex": 33, "endIndex": 35, "scopes": ["source.abl", "keyword.operator.abl"] },  // '?:'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 36, "endIndex": 38, "scopes": ["source.abl", "keyword.operator.abl"] },  // '?:'
    { "startIndex": 38, "endIndex": 49, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'AdapterType'
    { "startIndex": 49, "endIndex": 50, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 7, "endIndex": 8, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 8, "endIndex": 15, "scopes": ["source.abl", "variable.language.abl"] },  // 'session'
    { "startIndex": 15, "endIndex": 17, "scopes": ["source.abl", "keyword.operator.abl"] },  // '?:'
    { "startIndex": 17, "endIndex": 37, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'current-request-info'
    { "startIndex": 37, "endIndex": 39, "scopes": ["source.abl", "keyword.operator.abl"] },  // '?:'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 4, "endIndex": 6, "scopes": ["source.abl", "keyword.operator.abl"] },  // '?:'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
    { "startIndex": 14, "endIndex": 16, "scopes": ["source.abl", "keyword.operator.abl"] },  // '?:'
    { "startIndex": 16, "endIndex": 22, "scopes": ["source.abl", "entity.name.function.abl"] }  // 'aField'
  ];
  shared.itShouldMatchExpectedScopes(statement, expectedTokens);
})
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 4, "endIndex": 5, "scopes": ["source.abl", "meta.function-call.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 5, "endIndex": 8, "scopes": ["source.abl", "meta.function-call.abl", "variable.other.abl"] },  // 'obj'
    { "startIndex": 8, "endIndex": 10, "scopes": ["source.abl", "meta.function-call.abl", "keyword.operator.abl"] },  // '?:'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 7, "endIndex": 8, "scopes": ["source.abl", "meta.function-call.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 8, "endIndex": 11, "scopes": ["source.abl", "meta.function-call.abl", "variable.other.abl"] },  // 'obj'
    { "startIndex": 11, "endIndex": 13, "scopes": ["source.abl", "meta.function-call.abl", "keyword.operator.abl"] },  // '?:'
    { "startIndex": 13, "endIndex": 17, "scopes": ["source.abl", "meta.function-call.abl", "entity.name.function.abl"] },  // 'meth'
    { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl", "meta.function-call.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 18, "endIndex": 19, "scopes": ["source.abl", "meta.function-call.abl", "meta.brace.round.abl"] },  // ')'
    { "startIndex": 19, "endIndex": 21, "scopes": ["source.abl", "meta.function-call.abl", "keyword.operator.abl"] },  // '?:'
    ...
    { "startIndex": 33, "endIndex": 34, "scopes": ["source.abl", "meta.function-call.abl", "meta.brace.round.abl"] }  // ')'
  ];
  shared.itShouldMatchExpectedScopes(statement, expectedTokens);
})
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 7, "endIndex": 8, "scopes": ["source.abl", "meta.function-call.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 8, "endIndex": 11, "scopes": ["source.abl", "meta.function-call.abl", "variable.other.abl"] },  // 'obj'
    { "startIndex": 11, "endIndex": 12, "scopes": ["source.abl", "meta.function-call.abl", "punctuation.accessor.abl"] },  // ':'
    { "startIndex": 12, "endIndex": 16, "scopes": ["source.abl", "meta.function-call.abl", "entity.name.function.abl"] },  // 'meth'
    { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl", "meta.function-call.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl", "meta.function-call.abl", "meta.brace.round.abl"] },  // ')'
    { "startIndex": 18, "endIndex": 20, "scopes": ["source.abl", "meta.function-call.abl", "keyword.operator.abl"] },  // '?:'
