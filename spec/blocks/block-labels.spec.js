...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 62, "endIndex": 63, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 63, "endIndex": 64, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
    { "startIndex": 64, "endIndex": 71, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'SH0057A'
    { "startIndex": 71, "endIndex": 72, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
    { "startIndex": 72, "endIndex": 73, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
