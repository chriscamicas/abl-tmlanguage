...
DirChar = if opsys begins 'win':u then '\\':u else '/':u.`;
  let expectedTokens = [
    [
      ...
      { "startIndex": 8, "endIndex": 15, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl", "variable.other.abl"] },  // 'DirChar'
      ...
      { "startIndex": 19, "endIndex": 23, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl", "storage.type.abl"] },  // 'char'
      { "startIndex": 23, "endIndex": 24, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl"] },  // ' '
      { "startIndex": 24, "endIndex": 31, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl", "keyword.other.abl"] },  // 'no-undo'
      ...
      { "startIndex": 13, "endIndex": 18, "scopes": ["source.abl", "keyword.other.abl"] },  // 'opsys'
      { "startIndex": 18, "endIndex": 19, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 19, "endIndex": 25, "scopes": ["source.abl", "keyword.other.abl"] },  // 'begins'
      ...
      { "startIndex": 32, "endIndex": 33, "scopes": ["source.abl", "support.function.abl"] },  // ':u'
      ...
      { "startIndex": 43, "endIndex": 44, "scopes": ["source.abl", "support.function.abl"] },  // ':u'
...
DirChar = if opsys begins "win":u then "\\":u else "/":u.`;
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 53, "endIndex": 54, "scopes": ["source.abl"] },
      { "startIndex": 54, "endIndex": 55, "scopes": ["source.abl", "support.function.abl"] },  // ':u'
      { "startIndex": 55, "endIndex": 56, "scopes": ["source.abl", "punctuation.terminator.abl"] }  // '.'
    ]
  ];
  shared.itShouldMatchExpectedScopes(statement, expectedTokens);
