...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 16, "endIndex": 26, "scopes": ["source.abl", "variable.other.abl"] },  // 'oEventArgs'
      { "startIndex": 26, "endIndex": 27, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      { "startIndex": 27, "endIndex": 39, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'ResponseBody'
