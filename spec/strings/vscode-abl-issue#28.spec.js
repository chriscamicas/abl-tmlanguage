...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 9, "endIndex": 12, "scopes": ["source.abl", "string.quoted.double.abl"] },  // '123'
    { "startIndex": 12, "endIndex": 13, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
    ...
    { "startIndex": 21, "endIndex": 22, "scopes": ["source.abl", "string.quoted.double.abl"] },  // ')'
    { "startIndex": 22, "endIndex": 23, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
