...
assign attrValue = BuildAttributeValue(string(attribNames[attribLoop]), annoData).`;
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 39, "endIndex": 45, "scopes": ["source.abl", "support.function.abl"] },  // 'string'
      { "startIndex": 45, "endIndex": 46, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 46, "endIndex": 57, "scopes": ["source.abl", "variable.other.abl"] },  // 'attribNames'
      { "startIndex": 57, "endIndex": 58, "scopes": ["source.abl", "meta.array.literal.abl", "punctuation.definition.bracket.square.begin.abl"] },  // '['
      { "startIndex": 58, "endIndex": 68, "scopes": ["source.abl", "meta.array.literal.abl", "variable.other.abl"] },  // 'attribLoop'
      { "startIndex": 68, "endIndex": 69, "scopes": ["source.abl", "meta.array.literal.abl", "punctuation.definition.bracket.square.end.abl"] },  // ']'
      { "startIndex": 69, "endIndex": 70, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
      { "startIndex": 70, "endIndex": 71, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      { "startIndex": 71, "endIndex": 72, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 72, "endIndex": 80, "scopes": ["source.abl", "variable.other.abl"] },  // 'annoData'
