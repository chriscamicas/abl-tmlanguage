...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 70, "endIndex": 71, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "punctuation.definition.preprocessor.abl"] },  // '&'
      { "startIndex": 71, "endIndex": 73, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "keyword.control.directive.conditional.abl"] },  // 'IF'
      ...
      { "startIndex": 82, "endIndex": 83, "scopes": ["source.abl", "meta.define.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 83, "endIndex": 92, "scopes": ["source.abl", "meta.define.abl", "entity.name.function.preprocessor.abl"] },  // 'NO-BEFORE'
      { "startIndex": 92, "endIndex": 93, "scopes": ["source.abl", "meta.define.abl", "meta.brace.round.abl"] },  // ')'
      ...
      { "startIndex": 97, "endIndex": 98, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '0'
      { "startIndex": 98, "endIndex": 99, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 99, "endIndex": 100, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "punctuation.definition.preprocessor.abl"] },  // '&'
      { "startIndex": 100, "endIndex": 104, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "keyword.control.directive.conditional.abl"] },  // 'THEN'
      ...
      { "startIndex": 140, "endIndex": 141, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "punctuation.definition.preprocessor.abl"] },  // '&'
      { "startIndex": 141, "endIndex": 146, "scopes": ["source.abl", "meta.define.abl", "meta.preprocessor.abl", "keyword.control.directive.conditional.abl"] }  // 'ENDIF'
    ],
    [
      { "startIndex": 0, "endIndex": 2, "scopes": ["source.abl", "meta.define.abl"] },  // '  '
      { "startIndex": 2, "endIndex": 7, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'FIELD'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 30, "endIndex": 31, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 31, "endIndex": 32, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '0'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 32, "endIndex": 33, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '0'
      { "startIndex": 33, "endIndex": 34, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
    ...
    [
      ...
      { "startIndex": 27, "endIndex": 28, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 28, "endIndex": 30, "scopes": ["source.abl", "meta.define.abl", "comment.block.abl"] },  // '/*'
      { "startIndex": 30, "endIndex": 36, "scopes": ["source.abl", "meta.define.abl", "comment.block.abl", "comment"] },  // 'unique'
      { "startIndex": 36, "endIndex": 38, "scopes": ["source.abl", "meta.define.abl", "comment.block.abl"] },  // '*/'
    ...
    [
      ...
      { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 18, "endIndex": 20, "scopes": ["source.abl", "meta.define.abl", "comment.block.abl"] },  // '/*'
      { "startIndex": 20, "endIndex": 26, "scopes": ["source.abl", "meta.define.abl", "comment.block.abl", "comment"] },  // 'unique'
