...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 69, "endIndex": 70, "scopes": ["source.abl", "meta.define.abl", "meta.brace.round.abl"] },  // '('
      ...
      { "startIndex": 85, "endIndex": 86, "scopes": ["source.abl", "meta.define.abl", "meta.brace.round.abl"] },  // ')'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 18, "endIndex": 19, "scopes": ["source.abl", "meta.define.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
      { "startIndex": 19, "endIndex": 25, "scopes": ["source.abl", "meta.define.abl", "string.quoted.double.abl"] },  // 'ns-uri'
    ...
    [
      ...
      { "startIndex": 21, "endIndex": 22, "scopes": ["source.abl", "meta.define.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
      { "startIndex": 22, "endIndex": 31, "scopes": ["source.abl", "meta.define.abl", "string.quoted.double.abl"] },  // 'ns-prefix'
      { "startIndex": 31, "endIndex": 32, "scopes": ["source.abl", "meta.define.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] }  // '"'
    ],
    [
      { "startIndex": 0, "endIndex": 4, "scopes": ["source.abl", "meta.define.abl"] },  // '    '
      ...
      { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 18, "endIndex": 19, "scopes": ["source.abl", "meta.define.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
      { "startIndex": 19, "endIndex": 22, "scopes": ["source.abl", "meta.define.abl", "string.quoted.double.abl"] },  // 'foo'
      { "startIndex": 22, "endIndex": 23, "scopes": ["source.abl", "meta.define.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] }  // '"'
    ],
    [
      { "startIndex": 0, "endIndex": 4, "scopes": ["source.abl", "meta.define.abl"] },  // '    '
    ...
    [
      ...
      { "startIndex": 19, "endIndex": 20, "scopes": ["source.abl", "meta.define.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
      { "startIndex": 20, "endIndex": 23, "scopes": ["source.abl", "meta.define.abl", "string.quoted.double.abl"] },  // 'foo'
      { "startIndex": 23, "endIndex": 24, "scopes": ["source.abl", "meta.define.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
      ...
      { "startIndex": 40, "endIndex": 47, "scopes": ["source.abl", "meta.define.abl", "string.quoted.double.abl"] },  // 'ELEMENT'
    ...
    [
      ...
      { "startIndex": 56, "endIndex": 57, "scopes": ["source.abl", "meta.define.abl", "meta.brace.round.abl"] },  // '('
