...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 34, "endIndex": 35, "scopes": ["source.abl", "keyword.operator.abl"] },  // '+'
...
Avogadro = decimal("6.02214076e+23").`;
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 19, "endIndex": 20, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
      { "startIndex": 20, "endIndex": 34, "scopes": ["source.abl", "string.quoted.double.abl"] },  // '6.02214076e+23'
...
jsondata = '~{ "somevalue": 123e+5 ~}'.`;
  let expectedTokens = [
    [
      ...
      { "startIndex": 17, "endIndex": 25, "scopes": ["source.abl", "variable.other.abl"] },  // 'jsondata'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 14, "endIndex": 23, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'somevalue'
    ...
    { "startIndex": 26, "endIndex": 32, "scopes": ["source.abl", "constant.numeric.abl"] },  // '123e+5'
