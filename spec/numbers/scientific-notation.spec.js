...
Avogadro = decimal("6.02214076e+23").`;
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 19, "endIndex": 20, "scopes": ["source.abl", "meta.function-call.abl", "meta.function.arguments.abl", "string.double.complex.abl", "punctuation.definition.string.begin.abl"] },  // '"'
      { "startIndex": 20, "endIndex": 34, "scopes": ["source.abl", "meta.function-call.abl", "meta.function.arguments.abl", "string.double.complex.abl"] },  // '6.02214076e+23'
      { "startIndex": 34, "endIndex": 35, "scopes": ["source.abl", "meta.function-call.abl", "meta.function.arguments.abl", "string.double.complex.abl", "punctuation.definition.string.end.abl"] },  // '"'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 63, "endIndex": 64, "scopes": ["source.abl", "meta.define.abl", "string.double.complex.abl", "punctuation.definition.string.begin.abl"] },  // '"'
    { "startIndex": 64, "endIndex": 76, "scopes": ["source.abl", "meta.define.abl", "string.double.complex.abl"] },  // '9.9999<<e+99'
...
jsondata = '~{ "somevalue": 123e+5 ~}'.`;
  let expectedTokens = [
    [
      ...
      { "startIndex": 30, "endIndex": 35, "scopes": ["source.abl", "string.double.complex.abl"] },  // 'utf-8'
      { "startIndex": 35, "endIndex": 36, "scopes": ["source.abl", "string.double.complex.abl", "punctuation.definition.string.end.abl"] },  // '"'
      { "startIndex": 36, "endIndex": 37, "scopes": ["source.abl", "punctuation.terminator.abl"] }  // '.'
    ],
    [
      ...
      { "startIndex": 11, "endIndex": 12, "scopes": ["source.abl", "string.single.complex.abl", "punctuation.definition.string.begin.abl"] },  // '''
      { "startIndex": 12, "endIndex": 14, "scopes": ["source.abl", "string.single.complex.abl", "constant.character.escape.abl"] },  // '~{'
      { "startIndex": 14, "endIndex": 35, "scopes": ["source.abl", "string.single.complex.abl"] },  // ' "somevalue": 123e+5 '
      { "startIndex": 35, "endIndex": 37, "scopes": ["source.abl", "string.single.complex.abl", "constant.character.escape.abl"] },  // '~}'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 14, "endIndex": 23, "scopes": ["source.abl", "meta.function.arguments.abl", "string.double.complex.abl"] },  // 'somevalue'
    { "startIndex": 23, "endIndex": 24, "scopes": ["source.abl", "meta.function.arguments.abl", "string.double.complex.abl", "punctuation.definition.string.end.abl"] },  // '"'
