...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 3, "endIndex": 14, "scopes": ["source.abl", "meta.function-call.abl", "support.function.abl"] },  // 'num-entries'
      { "startIndex": 14, "endIndex": 15, "scopes": ["source.abl", "meta.function-call.abl", "meta.function.arguments.abl", "meta.brace.round.js"] },  // '('
      { "startIndex": 15, "endIndex": 28, "scopes": ["source.abl", "meta.function-call.abl", "meta.function.arguments.abl", "variable.other.abl"] },  // 'vBufferHandle'
      { "startIndex": 28, "endIndex": 30, "scopes": ["source.abl", "meta.function-call.abl", "meta.function.arguments.abl"] },  // '::'
      { "startIndex": 30, "endIndex": 41, "scopes": ["source.abl", "meta.function-call.abl", "meta.function.arguments.abl", "storage.data.table.abl"] },  // 'ControlList'
...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl", "meta.block.abl", "meta.function-call.abl"] },  // ' '
      { "startIndex": 17, "endIndex": 28, "scopes": ["source.abl", "meta.block.abl", "meta.function-call.abl", "support.function.abl"] },  // 'num-entries'
      { "startIndex": 28, "endIndex": 29, "scopes": ["source.abl", "meta.block.abl", "meta.function-call.abl", "meta.function.arguments.abl", "meta.brace.round.js"] },  // '('
      { "startIndex": 29, "endIndex": 42, "scopes": ["source.abl", "meta.block.abl", "meta.function-call.abl", "meta.function.arguments.abl", "variable.other.abl"] },  // 'vBufferHandle'
      { "startIndex": 42, "endIndex": 44, "scopes": ["source.abl", "meta.block.abl", "meta.function-call.abl", "meta.function.arguments.abl"] },  // '::'
      { "startIndex": 44, "endIndex": 55, "scopes": ["source.abl", "meta.block.abl", "meta.function-call.abl", "meta.function.arguments.abl", "storage.data.table.abl"] },  // 'ControlList'
      { "startIndex": 55, "endIndex": 56, "scopes": ["source.abl", "meta.block.abl", "meta.function-call.abl", "meta.brace.round.js"] },  // ')'
