...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 2, "endIndex": 32, "scopes": ["source.abl", "comment.block.abl", "comment"] },  // ' must have no space after '1' '
      { "startIndex": 32, "endIndex": 34, "scopes": ["source.abl", "comment.block.abl"] }  // '*/'
    ],
    [
      ...
      { "startIndex": 27, "endIndex": 28, "scopes": ["source.abl", "constant.numeric.abl"] },  // '1'
      { "startIndex": 28, "endIndex": 29, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      { "startIndex": 29, "endIndex": 56, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'oe-credit-class.DESCRIPTION'
      { "startIndex": 56, "endIndex": 57, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      { "startIndex": 57, "endIndex": 58, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 58, "endIndex": 59, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
      { "startIndex": 59, "endIndex": 60, "scopes": ["source.abl", "string.quoted.double.abl"] },  // ' '
      { "startIndex": 60, "endIndex": 61, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 25, "endIndex": 26, "scopes": ["source.abl", "constant.numeric.abl"] },  // '1'
    { "startIndex": 26, "endIndex": 27, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
    { "startIndex": 27, "endIndex": 28, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 28, "endIndex": 55, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'oe-credit-class.DESCRIPTION'
    ...
    { "startIndex": 58, "endIndex": 59, "scopes": ["source.abl", "string.quoted.double.abl"] },  // ' '
