...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 121, "endIndex": 122, "scopes": ["source.abl", "keyword.operator.abl"] },  // '<'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 24, "endIndex": 25, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 25, "endIndex": 26, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 26, "endIndex": 37, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'month_quota'
    { "startIndex": 37, "endIndex": 38, "scopes": ["source.abl", "meta.array.literal.abl", "punctuation.definition.bracket.square.begin.abl"] },  // '['
    { "startIndex": 38, "endIndex": 39, "scopes": ["source.abl", "meta.array.literal.abl", "constant.numeric.abl"] },  // '1'
    { "startIndex": 39, "endIndex": 40, "scopes": ["source.abl", "meta.array.literal.abl", "punctuation.definition.bracket.square.end.abl"] },  // ']'
    { "startIndex": 40, "endIndex": 41, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 41, "endIndex": 52, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'month_quota'
    { "startIndex": 52, "endIndex": 53, "scopes": ["source.abl", "meta.array.literal.abl", "punctuation.definition.bracket.square.begin.abl"] },  // '['
    { "startIndex": 53, "endIndex": 55, "scopes": ["source.abl", "meta.array.literal.abl", "constant.numeric.abl"] },  // '12'
    { "startIndex": 55, "endIndex": 56, "scopes": ["source.abl", "meta.array.literal.abl", "punctuation.definition.bracket.square.end.abl"] },  // ']'
