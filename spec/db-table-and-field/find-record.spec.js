...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 15, "endIndex": 31, "scopes": ["source.abl", "support.data.table.abl"] },  // 'z_anchor.z_print'
...
`;
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 5, "endIndex": 14, "scopes": ["source.abl", "support.function.abl"] },  // 'AVAILABLE'
      { "startIndex": 14, "endIndex": 15, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 15, "endIndex": 22, "scopes": ["source.abl", "support.data.table.abl"] },  // 'z_print'
