...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 21, "endIndex": 31, "scopes": ["source.abl", "variable.other.abl"] },  // 'expression'
    { "startIndex": 31, "endIndex": 32, "scopes": ["source.abl"] },  // ' '
    ...
    { "startIndex": 55, "endIndex": 65, "scopes": ["source.abl", "variable.other.abl"] },  // 'expression'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 51, "endIndex": 58, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'tt.fld1'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 42, "endIndex": 53, "scopes": ["source.abl", "variable.other.abl"] },  // 'user_dbname'
    { "startIndex": 53, "endIndex": 54, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
