...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 10, "endIndex": 14, "scopes": ["source.abl", "meta.preprocessor.abl", "entity.name.function.preprocessor.abl"] },  // 'file'
    { "startIndex": 14, "endIndex": 15, "scopes": ["source.abl", "meta.preprocessor.abl", "punctuation.section.abl"] },  // '}'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 39, "endIndex": 41, "scopes": ["source.abl", "keyword.operator.abl"] },  // '<>'
