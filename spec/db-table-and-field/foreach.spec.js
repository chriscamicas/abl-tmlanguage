...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 18, "endIndex": 19, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      ...
      { "startIndex": 71, "endIndex": 77, "scopes": ["source.abl", "keyword.operator.abl"] },  // 'begins'
      ...
      { "startIndex": 145, "endIndex": 146, "scopes": ["source.abl", "keyword.operator.abl"] },  // '<'
...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 8, "endIndex": 9, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 9, "endIndex": 17, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'customer'
      { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      ...
      { "startIndex": 47, "endIndex": 48, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      ...
      { "startIndex": 102, "endIndex": 103, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 103, "endIndex": 104, "scopes": ["source.abl", "keyword.operator.abl"] },  // '<'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 59, "endIndex": 60, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
      { "startIndex": 60, "endIndex": 61, "scopes": ["source.abl"] },  // ' '
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 52, "endIndex": 54, "scopes": ["source.abl", "keyword.operator.abl"] },  // 'EQ'
    { "startIndex": 54, "endIndex": 55, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 55, "endIndex": 72, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'customer.salesrep'
    { "startIndex": 72, "endIndex": 73, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 73, "endIndex": 80, "scopes": ["source.abl", "keyword.other.abl"] },  // 'no-lock'
    { "startIndex": 80, "endIndex": 81, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
    { "startIndex": 81, "endIndex": 82, "scopes": ["source.abl"] },  // ' '
    ...
    { "startIndex": 136, "endIndex": 137, "scopes": ["source.abl", "keyword.operator.abl"] },  // '<'
...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 102, "endIndex": 103, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
    ...
    [
      ...
      { "startIndex": 6, "endIndex": 7, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      { "startIndex": 7, "endIndex": 8, "scopes": ["source.abl"] },  // ' '
...
first order of customer no-lock where order.orderdate < today:`;
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 33, "endIndex": 35, "scopes": ["source.abl", "keyword.operator.abl"] },  // 'EQ'
      { "startIndex": 35, "endIndex": 36, "scopes": ["source.abl"] },  // ' '
      ...
      { "startIndex": 61, "endIndex": 62, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      ...
      { "startIndex": 53, "endIndex": 54, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 54, "endIndex": 55, "scopes": ["source.abl", "keyword.operator.abl"] },  // '<'
      { "startIndex": 55, "endIndex": 56, "scopes": ["source.abl"] },  // ' '
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 32, "endIndex": 33, "scopes": ["source.abl", "meta.define.method.abl", "meta.brace.round.abl"] },  // '('
