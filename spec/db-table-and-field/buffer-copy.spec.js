...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 53, "endIndex": 54, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
    ...
    [
      ...
      { "startIndex": 60, "endIndex": 74, "scopes": ["source.abl", "storage.data.table.abl"] },  // 'custname.state'
      { "startIndex": 74, "endIndex": 75, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
...
EXCEPT f1 f4 af
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 39, "endIndex": 42, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'abf'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 54, "endIndex": 55, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 55, "endIndex": 56, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
    ...
    [
      ...
      { "startIndex": 56, "endIndex": 57, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
      { "startIndex": 57, "endIndex": 58, "scopes": ["source.abl"] },  // ' '
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 29, "endIndex": 30, "scopes": ["source.abl", "keyword.operator.abl"] },  // '='
      { "startIndex": 30, "endIndex": 31, "scopes": ["source.abl"] },  // ' '
      ...
      { "startIndex": 37, "endIndex": 39, "scopes": ["source.abl", "variable.other.abl"] },  // '_P'
    ...
    [
      ...
      { "startIndex": 31, "endIndex": 36, "scopes": ["source.abl", "support.function.abl"] },  // 'RECID'
      { "startIndex": 36, "endIndex": 37, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 37, "endIndex": 39, "scopes": ["source.abl", "variable.other.abl"] },  // '_U'
      { "startIndex": 39, "endIndex": 40, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
