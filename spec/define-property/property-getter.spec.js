...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 5, "endIndex": 9, "scopes": ["source.abl", "meta.define.abl", "needs.braces"] }  // '():'
    ],
    [
    ...
    [
      ...
      { "startIndex": 21, "endIndex": 29, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'Encoding'
      { "startIndex": 29, "endIndex": 30, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 30, "endIndex": 32, "scopes": ["source.abl", "meta.define.abl", "keyword.other.abl"] },  // 'eq'
      ...
      { "startIndex": 40, "endIndex": 42, "scopes": ["source.abl", "meta.define.abl", "support.other.abl"] },  // ':u'
    ...
    [
      ...
      { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 17, "endIndex": 27, "scopes": ["source.abl", "meta.define.abl", "entity.name.type.abl"] },  // 'mUTF8Value'
    ...
    [
      ...
      { "startIndex": 6, "endIndex": 10, "scopes": ["source.abl", "keyword.other.abl"] }  // 'else'
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl"] },  // '          '
      { "startIndex": 10, "endIndex": 16, "scopes": ["source.abl", "keyword.other.abl"] },  // 'return'
      { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl", "meta.function-call.abl"] },  // ' '
      { "startIndex": 17, "endIndex": 33, "scopes": ["source.abl", "meta.function-call.abl", "support.function.abl"] },  // 'codepage-convert'
      { "startIndex": 33, "endIndex": 34, "scopes": ["source.abl", "meta.function-call.abl", "meta.function.arguments.abl", "meta.brace.round.js"] },  // '('
      { "startIndex": 34, "endIndex": 44, "scopes": ["source.abl", "meta.function-call.abl", "meta.function.arguments.abl", "variable.other.abl"] },  // 'mUTF8Value'
      { "startIndex": 44, "endIndex": 45, "scopes": ["source.abl", "meta.function-call.abl", "meta.function.arguments.abl", "punctuation.separator.comma.abl"] },  // ','
      { "startIndex": 45, "endIndex": 46, "scopes": ["source.abl", "meta.function-call.abl", "meta.function.arguments.abl"] },  // ' '
      { "startIndex": 46, "endIndex": 57, "scopes": ["source.abl", "meta.function-call.abl", "meta.function.arguments.abl", "variable.language.abl"] },  // 'this-object'
      { "startIndex": 57, "endIndex": 58, "scopes": ["source.abl", "meta.function-call.abl", "meta.function.arguments.abl", "punctuation.separator.colon.abl"] },  // ':'
      { "startIndex": 58, "endIndex": 66, "scopes": ["source.abl", "meta.function-call.abl", "meta.function.arguments.abl", "entity.name.function.abl"] },  // 'Encoding'
    ...
    [
      ...
      { "startIndex": 6, "endIndex": 9, "scopes": ["source.abl", "keyword.other.abl"] },  // 'get'
