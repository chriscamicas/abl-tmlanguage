...
describe('', () => {
    let statement = `define protected temp-table ttData like Customer.`;
...
describe('', () => {
    ...
    let expectedTokens = [
        ...
        // 'extent'
        { "startIndex": 42, "endIndex": 48, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl", "keyword.other.abl"] },
        // ' '
        { "startIndex": 48, "endIndex": 49, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl"] },
        // '14'
        { "startIndex": 49, "endIndex": 51, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl", "constant.numeric.source.abl"] },
        // ' '
        { "startIndex": 51, "endIndex": 52, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl"] },
        // 'no'
        { "startIndex": 52, "endIndex": 54, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl", "entity.name.type.abl"] },
        // '-'
        { "startIndex": 54, "endIndex": 55, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl"] },
        // 'undo.'
        { "startIndex": 55, "endIndex": 60, "scopes": ["source.abl", "meta.define.abl", "meta.define.variable.abl", "entity.name.type.abl"] },
