...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 12, "endIndex": 13, "scopes": ["source.abl", "variable.other.abl"] },  // 'y'
    ...
    { "startIndex": 27, "endIndex": 35, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'Property'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'y'
    { "startIndex": 14, "endIndex": 15, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
    { "startIndex": 15, "endIndex": 18, "scopes": ["source.abl", "string.quoted.double.abl", "support.other.abl"] },  // ':L9'
    { "startIndex": 18, "endIndex": 19, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
    { "startIndex": 19, "endIndex": 20, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 20, "endIndex": 23, "scopes": ["source.abl", "support.function.abl"] },  // 'new'
    { "startIndex": 23, "endIndex": 24, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 24, "endIndex": 35, "scopes": ["source.abl", "entity.name.type.abl"] },  // 'foo.bar.baz'
    { "startIndex": 35, "endIndex": 36, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 8, "endIndex": 9, "scopes": ["source.abl", "meta.function-call.abl", "punctuation.accessor.abl"] },  // ':'
