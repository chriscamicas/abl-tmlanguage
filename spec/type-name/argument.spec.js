...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 4, "endIndex": 8, "scopes": ["source.abl", "meta.function-call.abl", "entity.name.function.abl"] },
    { "startIndex": 8, "endIndex": 9, "scopes": ["source.abl", "meta.function-call.abl", "meta.brace.round.js"] },
    { "startIndex": 9, "endIndex": 10, "scopes": ["source.abl", "meta.function-call.abl", "variable.other.abl"] },
...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 9, "endIndex": 10, "scopes": ["source.abl", "meta.function-call.abl", "entity.name.type.abl"] }
    ],
    [
      ...
      { "startIndex": 9, "endIndex": 20, "scopes": ["source.abl", "meta.function-call.abl", "entity.name.type.abl"] },
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 30, "endIndex": 41, "scopes": ["source.abl", "meta.function-call.abl", "entity.name.type.abl"] },
