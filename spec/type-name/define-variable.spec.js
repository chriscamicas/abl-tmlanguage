...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 29, "endIndex": 30, "scopes": ["source.abl", "meta.define.abl", "meta.generic.abl"] },  // ' '
...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 26, "endIndex": 27, "scopes": ["source.abl", "meta.define.abl", "meta.generic.abl"] },  // ' '
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 44, "endIndex": 45, "scopes": ["source.abl", "meta.define.abl"] },  // ' '
    { "startIndex": 45, "endIndex": 46, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '4'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 53, "endIndex": 54, "scopes": ["source.abl", "meta.define.abl", "constant.numeric.abl"] },  // '4'
