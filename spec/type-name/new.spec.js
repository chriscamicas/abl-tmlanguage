...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 33, "endIndex": 37, "scopes": ["source.abl", "constant.language.abl"] },  // 'true'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 32, "endIndex": 36, "scopes": ["source.abl", "constant.language.abl"] },  // 'true'
    { "startIndex": 36, "endIndex": 37, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
    { "startIndex": 37, "endIndex": 38, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 38, "endIndex": 39, "scopes": ["source.abl", "constant.language.abl"] },  // '?'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 53, "endIndex": 56, "scopes": ["source.abl", "support.function.abl"] },  // 'new'
