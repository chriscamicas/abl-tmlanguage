...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 9, "endIndex": 10, "scopes": ["source.abl", "meta.function-call.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 10, "endIndex": 21, "scopes": ["source.abl", "meta.function-call.abl", "entity.name.type.abl"] },  // 'foo.bar.baz'
    { "startIndex": 21, "endIndex": 22, "scopes": ["source.abl", "meta.function-call.abl", "meta.brace.round.abl"] },  // ')'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 15, "endIndex": 26, "scopes": ["source.abl", "entity.name.type.abl"] },  // 'foo.bar.baz'
    { "startIndex": 26, "endIndex": 27, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 27, "endIndex": 31, "scopes": ["source.abl", "constant.language.abl"] },  // 'true'
    { "startIndex": 31, "endIndex": 32, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
    { "startIndex": 32, "endIndex": 33, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 33, "endIndex": 34, "scopes": ["source.abl", "constant.language.abl"] },  // '?'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 30, "endIndex": 34, "scopes": ["source.abl", "constant.language.abl"] },  // 'true'
    { "startIndex": 34, "endIndex": 35, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
    { "startIndex": 35, "endIndex": 36, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 36, "endIndex": 37, "scopes": ["source.abl", "constant.language.abl"] },  // '?'
...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 30, "endIndex": 38, "scopes": ["source.abl", "support.function.abl"] },  // 'READ-XML'
      ...
      { "startIndex": 40, "endIndex": 48, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'longchar'
      { "startIndex": 48, "endIndex": 49, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
      { "startIndex": 49, "endIndex": 51, "scopes": ["source.abl", "string.quoted.double.abl", "support.other.abl"] },  // ':U'
      { "startIndex": 51, "endIndex": 52, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 2, "scopes": ["source.abl"] },  // '  '
      { "startIndex": 2, "endIndex": 11, "scopes": ["source.abl", "variable.other.abl"] },  // 'lcDataset'
      { "startIndex": 11, "endIndex": 12, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 2, "scopes": ["source.abl"] },  // '  '
      { "startIndex": 2, "endIndex": 3, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
      { "startIndex": 3, "endIndex": 8, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'EMPTY'
      { "startIndex": 8, "endIndex": 9, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
      { "startIndex": 9, "endIndex": 11, "scopes": ["source.abl", "string.quoted.double.abl", "support.other.abl"] },  // ':U'
      { "startIndex": 11, "endIndex": 12, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      { "startIndex": 12, "endIndex": 13, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl", "constant.language.abl"] },  // '?'
      { "startIndex": 14, "endIndex": 15, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      { "startIndex": 15, "endIndex": 16, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl", "constant.language.abl"] },  // '?'
...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 47, "endIndex": 48, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      ...
      { "startIndex": 84, "endIndex": 85, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
    ...
    [
      ...
      { "startIndex": 67, "endIndex": 68, "scopes": ["source.abl", "constant.numeric.abl"] },  // '0'
      ...
      { "startIndex": 95, "endIndex": 96, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      { "startIndex": 96, "endIndex": 110, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'BusinessEntity'
      { "startIndex": 110, "endIndex": 111, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
