...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 17, "endIndex": 29, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'path/to/file'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 10, "endIndex": 15, "scopes": ["source.abl", "support.function.abl"] },  // 'value'
    { "startIndex": 15, "endIndex": 16, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 16, "endIndex": 28, "scopes": ["source.abl", "variable.other.abl"] },  // 'cv-file-name'
...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 28, "endIndex": 31, "scopes": ["source.abl", "variable.other.abl"] },  // 'fil'
      ...
      { "startIndex": 47, "endIndex": 53, "scopes": ["source.abl", "variable.other.abl"] },  // 'lobdir'
      { "startIndex": 53, "endIndex": 54, "scopes": ["source.abl", "meta.brace.round.abl"] }  // ')'
    ],
    [
