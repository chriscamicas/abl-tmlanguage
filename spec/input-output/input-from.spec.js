...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 18, "endIndex": 30, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'path/to/file'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 11, "endIndex": 16, "scopes": ["source.abl", "support.function.abl"] },  // 'value'
    { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 17, "endIndex": 29, "scopes": ["source.abl", "variable.other.abl"] },  // 'cv-file-name'
...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 29, "endIndex": 32, "scopes": ["source.abl", "variable.other.abl"] },  // 'fil'
      ...
      { "startIndex": 48, "endIndex": 54, "scopes": ["source.abl", "variable.other.abl"] },  // 'lobdir'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 18, "endIndex": 27, "scopes": ["source.abl", "support.function.abl"] },  // 'SUBSTRING'
      { "startIndex": 27, "endIndex": 28, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 28, "endIndex": 36, "scopes": ["source.abl", "variable.other.abl"] },  // 'user_env'
      { "startIndex": 36, "endIndex": 37, "scopes": ["source.abl", "meta.array.literal.abl", "punctuation.definition.bracket.square.begin.abl"] },  // '['
      { "startIndex": 37, "endIndex": 38, "scopes": ["source.abl", "meta.array.literal.abl", "constant.numeric.abl"] },  // '3'
      { "startIndex": 38, "endIndex": 39, "scopes": ["source.abl", "meta.array.literal.abl", "punctuation.definition.bracket.square.end.abl"] },  // ']'
      { "startIndex": 39, "endIndex": 40, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      { "startIndex": 40, "endIndex": 41, "scopes": ["source.abl", "constant.numeric.abl"] },  // '5'
      { "startIndex": 41, "endIndex": 42, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      { "startIndex": 42, "endIndex": 44, "scopes": ["source.abl", "constant.numeric.abl"] },  // '-1'
      { "startIndex": 44, "endIndex": 45, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
      { "startIndex": 45, "endIndex": 46, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
      { "startIndex": 46, "endIndex": 55, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'character'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 55, "endIndex": 56, "scopes": ["source.abl", "meta.array.literal.abl", "constant.numeric.abl"] },  // '5'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 32, "endIndex": 33, "scopes": ["source.abl", "meta.array.literal.abl", "constant.numeric.abl"] },  // '4'
      ...
      { "startIndex": 51, "endIndex": 52, "scopes": ["source.abl", "meta.array.literal.abl", "constant.numeric.abl"] },  // '5'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 18, "endIndex": 24, "scopes": ["source.abl", "variable.other.abl"] },  // 'CurDir'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 18, "endIndex": 27, "scopes": ["source.abl", "variable.other.abl"] },  // 's_logfile'
    { "startIndex": 27, "endIndex": 28, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
    { "startIndex": 28, "endIndex": 29, "scopes": ["source.abl"] },  // ' '
