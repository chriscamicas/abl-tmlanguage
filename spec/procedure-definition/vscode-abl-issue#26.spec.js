...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 10, "endIndex": 41, "scopes": ["source.abl", "meta.procedure.abl", "entity.name.function.abl"] },  // ''TpFrame.TaskPanel.ItemClick':U'
      { "startIndex": 41, "endIndex": 42, "scopes": ["source.abl", "meta.procedure.abl", "meta.procedure.body.abl"] }  // ':U'
    ], [
