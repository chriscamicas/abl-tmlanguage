...
`PROCEDURE EnumPrinters{&A} EXTERNAL "winspool.drv":
    ...
    let expectedTokens = [
        [
            ...
            {"startIndex":10,"endIndex":26,"scopes":["source.abl","meta.procedure.abl","entity.name.function.abl"]},
            { "startIndex": 26, "endIndex": 27, "scopes": ["source.abl", "meta.procedure.abl"] },
            { "startIndex": 27, "endIndex": 35, "scopes": ["source.abl", "meta.procedure.abl", "keyword.other.abl"] },
            ...
            { "startIndex": 37, "endIndex": 49, "scopes": ["source.abl", "meta.procedure.abl", "string.double.complex.abl"] },
            { "startIndex": 49, "endIndex": 50, "scopes": ["source.abl", "meta.procedure.abl", "punctuation.definition.string.end.abl"] },
