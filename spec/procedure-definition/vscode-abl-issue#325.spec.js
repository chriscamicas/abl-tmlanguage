...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 27, "endIndex": 32, "scopes": ["source.abl", "keyword.other.abl"] },  // 'input'
    { "startIndex": 32, "endIndex": 33, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 33, "endIndex": 34, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
