...
END PROCEDURE.`;
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 7, "endIndex": 13, "scopes": ["source.abl", "meta.procedure.abl", "meta.procedure.body.abl", "meta.define.abl", "keyword.other.abl"] },  // 'RETURN'
      { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl", "meta.procedure.abl", "meta.procedure.body.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 14, "endIndex": 23, "scopes": ["source.abl", "meta.procedure.abl", "meta.procedure.body.abl", "meta.define.abl", "keyword.other.abl"] },  // 'PARAMETER'
      { "startIndex": 23, "endIndex": 24, "scopes": ["source.abl", "meta.procedure.abl", "meta.procedure.body.abl", "meta.define.abl"] },  // ' '
      { "startIndex": 24, "endIndex": 40, "scopes": ["source.abl", "meta.procedure.abl", "meta.procedure.body.abl", "meta.define.abl", "variable.parameter.abl"] },  // 'intProcessHandle'
