...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 24, "endIndex": 29, "scopes": ["source.abl", "support.function.abl"] },  // 'today'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 13, "endIndex": 22, "scopes": ["source.abl", "variable.other.abl"] },  // 'cPriogram'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 20, "endIndex": 25, "scopes": ["source.abl", "keyword.other.abl"] },  // 'input'
    { "startIndex": 25, "endIndex": 26, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 26, "endIndex": 29, "scopes": ["source.abl", "constant.numeric.abl"] },  // '0x4'
    { "startIndex": 29, "endIndex": 30, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
    { "startIndex": 30, "endIndex": 31, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 31, "endIndex": 37, "scopes": ["source.abl", "keyword.other.abl"] },  // 'output'
    { "startIndex": 37, "endIndex": 38, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 38, "endIndex": 43, "scopes": ["source.abl", "variable.other.abl"] },  // 'cData'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 42, "endIndex": 47, "scopes": ["source.abl", "keyword.other.abl"] },  // 'input'
    { "startIndex": 47, "endIndex": 48, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 48, "endIndex": 51, "scopes": ["source.abl", "constant.numeric.abl"] },  // '0x4'
    { "startIndex": 51, "endIndex": 52, "scopes": ["source.abl", "punctuation.separator.comma.abl"] },  // ','
    { "startIndex": 52, "endIndex": 53, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 53, "endIndex": 59, "scopes": ["source.abl", "keyword.other.abl"] },  // 'output'
    { "startIndex": 59, "endIndex": 60, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 60, "endIndex": 65, "scopes": ["source.abl", "variable.other.abl"] },  // 'cData'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 37, "endIndex": 42, "scopes": ["source.abl", "constant.numeric.abl"] },  // '31000'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 38, "endIndex": 39, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 39, "endIndex": 44, "scopes": ["source.abl", "constant.numeric.abl"] },  // '31000'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 40, "endIndex": 45, "scopes": ["source.abl", "constant.numeric.abl"] },  // '31000'
    { "startIndex": 45, "endIndex": 46, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 9, "endIndex": 10, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 10, "endIndex": 16, "scopes": ["source.abl", "variable.other.abl"] },  // 'SYSSYS'
    ...
    { "startIndex": 19, "endIndex": 24, "scopes": ["source.abl", "constant.numeric.abl"] },  // '31000'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 6, "endIndex": 26, "scopes": ["source.abl", "comment.block.abl", "comment"] },  // 'debug remove / path '
...
describe('', () => {
  ...
  let expectedTokens = [
    [
      ...
      { "startIndex": 4, "endIndex": 9, "scopes": ["source.abl", "support.function.abl"] },  // 'VALUE'
      { "startIndex": 9, "endIndex": 10, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 10, "endIndex": 21, "scopes": ["source.abl", "variable.language.abl"] },  // 'THIS-OBJECT'
      { "startIndex": 21, "endIndex": 22, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      { "startIndex": 22, "endIndex": 42, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'ServiceInterfacePath'
      { "startIndex": 42, "endIndex": 43, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 43, "endIndex": 44, "scopes": ["source.abl", "keyword.operator.abl"] },  // '+'
      { "startIndex": 44, "endIndex": 45, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 45, "endIndex": 46, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
      { "startIndex": 46, "endIndex": 70, "scopes": ["source.abl", "string.quoted.double.abl"] },  // '/proSIinvokeTaskAsync2.p'
      { "startIndex": 70, "endIndex": 71, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
      { "startIndex": 71, "endIndex": 73, "scopes": ["source.abl", "string.quoted.double.abl", "support.other.abl"] },  // ':U'
      { "startIndex": 73, "endIndex": 74, "scopes": ["source.abl", "meta.brace.round.abl"] }  // ')'
    ],
    [
    ...
    [
      ...
      { "startIndex": 9, "endIndex": 14, "scopes": ["source.abl", "keyword.other.abl"] },  // 'INPUT'
      { "startIndex": 14, "endIndex": 15, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 15, "endIndex": 25, "scopes": ["source.abl", "variable.other.abl"] },  // 'pcTaskName'
      { "startIndex": 25, "endIndex": 26, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl"] },  // '          '
      { "startIndex": 10, "endIndex": 15, "scopes": ["source.abl", "keyword.other.abl"] },  // 'INPUT'
      { "startIndex": 15, "endIndex": 16, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 16, "endIndex": 28, "scopes": ["source.abl", "variable.other.abl"] },  // 'pcMethodName'
      { "startIndex": 28, "endIndex": 29, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl"] },  // '          '
      { "startIndex": 10, "endIndex": 11, "scopes": ["source.abl", "meta.argument.abl", "punctuation.section.abl"] },  // '{'
      { "startIndex": 11, "endIndex": 12, "scopes": ["source.abl", "meta.argument.abl", "support.other.argument.abl"] },  // '1'
      { "startIndex": 12, "endIndex": 13, "scopes": ["source.abl", "meta.argument.abl", "punctuation.section.abl"] },  // '}'
      { "startIndex": 13, "endIndex": 14, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl"] },  // '          '
      { "startIndex": 10, "endIndex": 20, "scopes": ["source.abl", "variable.other.abl"] },  // 'lcDataset1'
      { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl"] },  // '          '
      { "startIndex": 10, "endIndex": 20, "scopes": ["source.abl", "variable.other.abl"] },  // 'lcDataset2'
      { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl"] },  // '          '
      { "startIndex": 10, "endIndex": 20, "scopes": ["source.abl", "variable.other.abl"] },  // 'lcDataset3'
      { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl"] },  // '          '
      { "startIndex": 10, "endIndex": 20, "scopes": ["source.abl", "variable.other.abl"] },  // 'lcDataset4'
      { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl"] },  // '          '
      { "startIndex": 10, "endIndex": 20, "scopes": ["source.abl", "variable.other.abl"] },  // 'lcDataset5'
      { "startIndex": 20, "endIndex": 21, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl"] },  // '          '
      { "startIndex": 10, "endIndex": 21, "scopes": ["source.abl", "variable.other.abl"] },  // 'lcParameter'
      { "startIndex": 21, "endIndex": 22, "scopes": ["source.abl", "punctuation.separator.comma.abl"] }  // ','
    ],
    [
      { "startIndex": 0, "endIndex": 10, "scopes": ["source.abl"] },  // '          '
      { "startIndex": 10, "endIndex": 19, "scopes": ["source.abl", "variable.other.abl"] },  // 'lcContext'
      { "startIndex": 19, "endIndex": 20, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 28, "endIndex": 33, "scopes": ["source.abl", "keyword.other.abl"] },  // 'input'
    { "startIndex": 33, "endIndex": 34, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 34, "endIndex": 35, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
    { "startIndex": 35, "endIndex": 46, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'hello World'
    { "startIndex": 46, "endIndex": 47, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
...
describe('', () => {
  ...
  let expectedTokens = [
    ...
    { "startIndex": 31, "endIndex": 32, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
    { "startIndex": 32, "endIndex": 37, "scopes": ["source.abl", "keyword.other.abl"] },  // 'input'
    { "startIndex": 37, "endIndex": 38, "scopes": ["source.abl"] },  // ' '
    { "startIndex": 38, "endIndex": 39, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
    { "startIndex": 39, "endIndex": 46, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'goodbye'
    { "startIndex": 46, "endIndex": 47, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.end.abl"] },  // '"'
    { "startIndex": 47, "endIndex": 48, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
    { "startIndex": 48, "endIndex": 49, "scopes": ["source.abl", "punctuation.terminator.abl"] }  // '.'
  ];
 ...
 ( "abc", objRef) .`;
  ...
  let expectedTokens = [
    ...
    [
      ...
      { "startIndex": 33, "endIndex": 51, "scopes": ["source.abl", "variable.other.abl"] },  // 'event-handler-name'
      { "startIndex": 51, "endIndex": 52, "scopes": ["source.abl", "punctuation.accessor.abl"] },  // ':'
      { "startIndex": 52, "endIndex": 58, "scopes": ["source.abl", "entity.name.function.abl"] },  // 'Method'
    ...
    [
      ...
      { "startIndex": 1, "endIndex": 2, "scopes": ["source.abl", "meta.brace.round.abl"] },  // '('
      { "startIndex": 2, "endIndex": 3, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 3, "endIndex": 4, "scopes": ["source.abl", "string.quoted.double.abl", "punctuation.definition.string.begin.abl"] },  // '"'
      { "startIndex": 4, "endIndex": 7, "scopes": ["source.abl", "string.quoted.double.abl"] },  // 'abc'
      ...
      { "startIndex": 9, "endIndex": 10, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 10, "endIndex": 16, "scopes": ["source.abl", "variable.other.abl"] },  // 'objRef'
      { "startIndex": 16, "endIndex": 17, "scopes": ["source.abl", "meta.brace.round.abl"] },  // ')'
      { "startIndex": 17, "endIndex": 18, "scopes": ["source.abl"] },  // ' '
      { "startIndex": 18, "endIndex": 19, "scopes": ["source.abl", "punctuation.terminator.abl"] }  // '.'
    ]
